...
func I_A(attributes IAttributes, children ...any) *ElementI {
	return &ElementI{
...
func I_E(eventHandlers IEventHandlers, children ...any) *ElementI {
	return &ElementI{
...
func I_AE(attributes IAttributes, eventHandlers IEventHandlers, children ...any) *ElementI {
	return &ElementI{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementI) HandlebarElement() {}

func (element ElementI) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("i", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("i", attrs)
