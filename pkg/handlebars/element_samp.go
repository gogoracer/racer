...
type ElementSamp struct {
	...
	EventHandlers SampEventHandlers
...
func SAMP_A(attributes SampAttributes, children ...any) *ElementSamp {
	return &ElementSamp{
...
func SAMP_E(eventHandlers SampEventHandlers, children ...any) *ElementSamp {
	return &ElementSamp{
...
func SAMP_AE(attributes SampAttributes, eventHandlers SampEventHandlers, children ...any) *ElementSamp {
	return &ElementSamp{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementSamp) HandlebarElement() {}

func (element ElementSamp) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("samp", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("samp", attrs)
