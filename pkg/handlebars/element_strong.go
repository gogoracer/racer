...
type StrongEventHandlers struct {
...
type ElementStrong struct {
	...
	EventHandlers StrongEventHandlers
...
func STRONG_A(attributes StrongAttributes, children ...any) *ElementStrong {
	return &ElementStrong{
...
func STRONG_E(eventHandlers StrongEventHandlers, children ...any) *ElementStrong {
	return &ElementStrong{
...
func STRONG_AE(attributes StrongAttributes, eventHandlers StrongEventHandlers, children ...any) *ElementStrong {
	return &ElementStrong{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementStrong) HandlebarElement() {}

func (element ElementStrong) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("strong", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("strong", attrs)
