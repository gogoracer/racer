...
type NoscriptEventHandlers struct {
...
type ElementNoscript struct {
	...
	EventHandlers NoscriptEventHandlers
...
func NOSCRIPT_A(attributes NoscriptAttributes, children ...any) *ElementNoscript {
	return &ElementNoscript{
...
func NOSCRIPT_E(eventHandlers NoscriptEventHandlers, children ...any) *ElementNoscript {
	return &ElementNoscript{
...
func NOSCRIPT_AE(attributes NoscriptAttributes, eventHandlers NoscriptEventHandlers, children ...any) *ElementNoscript {
	return &ElementNoscript{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementNoscript) HandlebarElement() {}

func (element ElementNoscript) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("noscript", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("noscript", attrs)
