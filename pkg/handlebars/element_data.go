...
type ElementData struct {
	...
	EventHandlers DataEventHandlers
...
func DATA_A(attributes DataAttributes, children ...any) *ElementData {
	return &ElementData{
...
func DATA_E(eventHandlers DataEventHandlers, children ...any) *ElementData {
	return &ElementData{
...
func DATA_AE(attributes DataAttributes, eventHandlers DataEventHandlers, children ...any) *ElementData {
	return &ElementData{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementData) HandlebarElement() {}

func (element ElementData) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("data", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("data", attrs)
