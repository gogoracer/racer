...
type ObjectEventHandlers struct {
...
type ElementObject struct {
	...
	EventHandlers ObjectEventHandlers
...
func OBJECT_A(attributes ObjectAttributes, children ...any) *ElementObject {
	return &ElementObject{
...
func OBJECT_E(eventHandlers ObjectEventHandlers, children ...any) *ElementObject {
	return &ElementObject{
...
func OBJECT_AE(attributes ObjectAttributes, eventHandlers ObjectEventHandlers, children ...any) *ElementObject {
	return &ElementObject{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementObject) HandlebarElement() {}

func (element ElementObject) GenerateVDOM() interface{} {
	...
	if element.Attributes.Data != "" {
		attrs["data"] = string(element.Attributes.Data)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("object", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("object", attrs)
