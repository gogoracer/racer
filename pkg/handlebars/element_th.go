...
func (e *ElementTh) setAttribute(k string, v string, dontEscape ...bool) *ElementTh {
...
func (element *ElementTh) Scope(v string, dontEscape ...bool) *ElementTh {
	element.setAttribute("scope", v, dontEscape...)
	return element
}
...
func (element *ElementTh) Abbr(v string, dontEscape ...bool) *ElementTh {
	element.setAttribute("abbr", v, dontEscape...)
	return element
}
