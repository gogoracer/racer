...
func TH_A(attributes ThAttributes, children ...any) *ElementTh {
	return &ElementTh{
...
func TH_E(eventHandlers ThEventHandlers, children ...any) *ElementTh {
	return &ElementTh{
...
func TH_AE(attributes ThAttributes, eventHandlers ThEventHandlers, children ...any) *ElementTh {
	return &ElementTh{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTh) HandlebarElement() {}

func (element ElementTh) GenerateVDOM() interface{} {
	...
	attrs := engine.Attrs{}
	if element.Attributes.Abbr != "" {
		attrs["abbr"] = string(element.Attributes.Abbr)
	}
	...
	if element.Attributes.Colspan != "" {
		attrs["colspan"] = string(element.Attributes.Colspan)
	}
	...
	if element.Attributes.Headers != "" {
		attrs["headers"] = string(element.Attributes.Headers)
	}
	...
	if element.Attributes.Rowspan != "" {
		attrs["rowspan"] = string(element.Attributes.Rowspan)
	}
	if element.Attributes.Scope != "" {
		attrs["scope"] = string(element.Attributes.Scope)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("th", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("th", attrs)
