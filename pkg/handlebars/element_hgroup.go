...
type HgroupEventHandlers struct {
...
type ElementHgroup struct {
	...
	EventHandlers HgroupEventHandlers
...
func HGROUP_A(attributes HgroupAttributes, children ...any) *ElementHgroup {
	return &ElementHgroup{
...
func HGROUP_E(eventHandlers HgroupEventHandlers, children ...any) *ElementHgroup {
	return &ElementHgroup{
...
func HGROUP_AE(attributes HgroupAttributes, eventHandlers HgroupEventHandlers, children ...any) *ElementHgroup {
	return &ElementHgroup{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementHgroup) HandlebarElement() {}

func (element ElementHgroup) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("hgroup", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("hgroup", attrs)
