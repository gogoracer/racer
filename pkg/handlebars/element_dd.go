...
func DD_A(attributes DdAttributes, children ...any) *ElementDd {
	return &ElementDd{
...
func DD_E(eventHandlers DdEventHandlers, children ...any) *ElementDd {
	return &ElementDd{
...
func DD_AE(attributes DdAttributes, eventHandlers DdEventHandlers, children ...any) *ElementDd {
	return &ElementDd{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementDd) HandlebarElement() {}

func (element ElementDd) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("dd", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("dd", attrs)
