...
type SectionEventHandlers struct {
...
type ElementSection struct {
	...
	EventHandlers SectionEventHandlers
...
func SECTION_A(attributes SectionAttributes, children ...any) *ElementSection {
	return &ElementSection{
...
func SECTION_E(eventHandlers SectionEventHandlers, children ...any) *ElementSection {
	return &ElementSection{
...
func SECTION_AE(attributes SectionAttributes, eventHandlers SectionEventHandlers, children ...any) *ElementSection {
	return &ElementSection{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementSection) HandlebarElement() {}

func (element ElementSection) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("section", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("section", attrs)
