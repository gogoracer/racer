...
type FormAttributes struct {
	...
	// Valid values are constrained to the following:
	//   * boolean-attribute
	Novalidate string `json:"novalidate"`
...
func FORM_A(attributes FormAttributes, children ...any) *ElementForm {
	return &ElementForm{
...
func FORM_E(eventHandlers FormEventHandlers, children ...any) *ElementForm {
	return &ElementForm{
...
func FORM_AE(attributes FormAttributes, eventHandlers FormEventHandlers, children ...any) *ElementForm {
	return &ElementForm{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementForm) HandlebarElement() {}

func (element ElementForm) GenerateVDOM() interface{} {
	...
	attrs := engine.Attrs{}
	if element.Attributes.AcceptCharset != "" {
		attrs["accept-charset"] = string(element.Attributes.AcceptCharset)
	}
	if element.Attributes.Accesskey != "" {
		attrs["accesskey"] = string(element.Attributes.Accesskey)
	}
	if element.Attributes.Action != "" {
		attrs["action"] = string(element.Attributes.Action)
	}
	...
	if element.Attributes.Enctype != "" {
		attrs["enctype"] = string(element.Attributes.Enctype)
	}
	...
	if element.Attributes.Method != "" {
		attrs["method"] = string(element.Attributes.Method)
	}
	...
	if element.Attributes.Novalidate != "" {
		attrs["novalidate"] = string(element.Attributes.Novalidate)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("form", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("form", attrs)
