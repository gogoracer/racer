...
type ElementBdi struct {
	...
	EventHandlers BdiEventHandlers
...
func BDI_A(attributes BdiAttributes, children ...any) *ElementBdi {
	return &ElementBdi{
...
func BDI_E(eventHandlers BdiEventHandlers, children ...any) *ElementBdi {
	return &ElementBdi{
...
func BDI_AE(attributes BdiAttributes, eventHandlers BdiEventHandlers, children ...any) *ElementBdi {
	return &ElementBdi{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementBdi) HandlebarElement() {}

func (element ElementBdi) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("bdi", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("bdi", attrs)
