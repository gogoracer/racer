...
type TfootEventHandlers struct {
...
type ElementTfoot struct {
	...
	EventHandlers TfootEventHandlers
...
func TFOOT_A(attributes TfootAttributes, children ...any) *ElementTfoot {
	return &ElementTfoot{
...
func TFOOT_E(eventHandlers TfootEventHandlers, children ...any) *ElementTfoot {
	return &ElementTfoot{
...
func TFOOT_AE(attributes TfootAttributes, eventHandlers TfootEventHandlers, children ...any) *ElementTfoot {
	return &ElementTfoot{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTfoot) HandlebarElement() {}

func (element ElementTfoot) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("tfoot", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("tfoot", attrs)
