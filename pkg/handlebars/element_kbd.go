...
type ElementKbd struct {
	...
	EventHandlers KbdEventHandlers
...
func KBD_A(attributes KbdAttributes, children ...any) *ElementKbd {
	return &ElementKbd{
...
func KBD_E(eventHandlers KbdEventHandlers, children ...any) *ElementKbd {
	return &ElementKbd{
...
func KBD_AE(attributes KbdAttributes, eventHandlers KbdEventHandlers, children ...any) *ElementKbd {
	return &ElementKbd{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementKbd) HandlebarElement() {}

func (element ElementKbd) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("kbd", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("kbd", attrs)
