...
func (e *ElementKbd) Custom(k, v string) *ElementKbd {
	e.attrs[k] = v
	return e
}

func (e *ElementKbd) BindCustom(k string, v bool) *ElementKbd {
	e.shouldBeComponent = true
	return e
}

func (e ElementKbd) HandlebarElement() {}

func (e ElementKbd) GenerateVDOM() interface{} {
	all := append([]any{e.attrs}, e.children...)
	if e.shouldBeComponent {
		return engine.NewComponent("kbd", all...)
	} else {
		return engine.NewTag("kbd", all...)
	}
}
...
//   - string-is
func (e *ElementKbd) Accesskey(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["accesskey"] = v
...
//	*
//	*
func (e *ElementKbd) Autocapitalize(v string) *ElementKbd {
	if v == "" {
		return e
	}
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementKbd) Autofocus(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["autofocus"] = v
...
func (e *ElementKbd) Class(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["class"] = v
...
//   - true
//   - false
func (e *ElementKbd) Contenteditable(v string) *ElementKbd {
	if v == "" {
		return e
	}
...
//	*
//	*
func (e *ElementKbd) Dir(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["dir"] = v
...
//   - true
//   - false
func (e *ElementKbd) Draggable(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["draggable"] = v
...
//	*
//	*
func (e *ElementKbd) Enterkeyhint(v string) *ElementKbd {
	if v == "" {
		return e
	}
...
//	*
//	*
func (e *ElementKbd) Hidden(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["hidden"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementKbd) Id(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["id"] = v
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementKbd) Inert(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["inert"] = v
...
//	*
//	*
func (e *ElementKbd) Inputmode(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["inputmode"] = v
...
func (e *ElementKbd) Is(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["is"] = v
...
func (e *ElementKbd) Itemid(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["itemid"] = v
...
func (e *ElementKbd) Itemprop(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["itemprop"] = v
...
// Valid values are constrained to the following:
//   - unordered-set-of-unique-space-separated-tokens
func (e *ElementKbd) Itemref(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["itemref"] = v
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementKbd) Itemscope(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["itemscope"] = v
...
//   - unordered-set-of-unique-space-separated-tokens
//   - syntax-url-absolute
func (e *ElementKbd) Itemtype(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["itemtype"] = v
...
//
// Valid values are constrained to the following:
func (e *ElementKbd) Lang(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["lang"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementKbd) Nonce(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["nonce"] = v
...
//	*
//	*
func (e *ElementKbd) Popover(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["popover"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementKbd) Slot(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["slot"] = v
...
//   - true
//   - false
func (e *ElementKbd) Spellcheck(v string) *ElementKbd {
	if v == "" {
		return e
	}
...
// Valid values are constrained to the following:
func (e *ElementKbd) Style(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["style"] = v
...
// Valid values are constrained to the following:
//   - valid-integer
func (e *ElementKbd) Tabindex(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["tabindex"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementKbd) Title(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["title"] = v
...
//   - yes
//   - no
func (e *ElementKbd) Translate(v string) *ElementKbd {
	if v == "" {
		return e
	}
	e.attrs["translate"] = v
