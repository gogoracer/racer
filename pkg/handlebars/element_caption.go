...
type CaptionEventHandlers struct {
...
func CAPTION_A(attributes CaptionAttributes, children ...any) *ElementCaption {
	return &ElementCaption{
...
func CAPTION_E(eventHandlers CaptionEventHandlers, children ...any) *ElementCaption {
	return &ElementCaption{
...
func CAPTION_AE(attributes CaptionAttributes, eventHandlers CaptionEventHandlers, children ...any) *ElementCaption {
	return &ElementCaption{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementCaption) HandlebarElement() {}

func (element ElementCaption) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("caption", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("caption", attrs)
