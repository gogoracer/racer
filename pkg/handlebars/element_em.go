...
func EM_A(attributes EmAttributes, children ...any) *ElementEm {
	return &ElementEm{
...
func EM_E(eventHandlers EmEventHandlers, children ...any) *ElementEm {
	return &ElementEm{
...
func EM_AE(attributes EmAttributes, eventHandlers EmEventHandlers, children ...any) *ElementEm {
	return &ElementEm{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementEm) HandlebarElement() {}

func (element ElementEm) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("em", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("em", attrs)
