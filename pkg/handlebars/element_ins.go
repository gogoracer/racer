...
type ElementIns struct {
	...
	EventHandlers InsEventHandlers
...
func INS_A(attributes InsAttributes, children ...any) *ElementIns {
	return &ElementIns{
...
func INS_E(eventHandlers InsEventHandlers, children ...any) *ElementIns {
	return &ElementIns{
...
func INS_AE(attributes InsAttributes, eventHandlers InsEventHandlers, children ...any) *ElementIns {
	return &ElementIns{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementIns) HandlebarElement() {}

func (element ElementIns) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("ins", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("ins", attrs)
