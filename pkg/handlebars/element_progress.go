...
type ElementProgress struct {
	...
	EventHandlers ProgressEventHandlers
...
func PROGRESS_A(attributes ProgressAttributes, children ...any) *ElementProgress {
	return &ElementProgress{
...
func PROGRESS_E(eventHandlers ProgressEventHandlers, children ...any) *ElementProgress {
	return &ElementProgress{
...
func PROGRESS_AE(attributes ProgressAttributes, eventHandlers ProgressEventHandlers, children ...any) *ElementProgress {
	return &ElementProgress{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementProgress) HandlebarElement() {}

func (element ElementProgress) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("progress", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("progress", attrs)
