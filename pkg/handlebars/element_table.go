...
type TableEventHandlers struct {
...
func TABLE_A(attributes TableAttributes, children ...any) *ElementTable {
	return &ElementTable{
...
func TABLE_E(eventHandlers TableEventHandlers, children ...any) *ElementTable {
	return &ElementTable{
...
func TABLE_AE(attributes TableAttributes, eventHandlers TableEventHandlers, children ...any) *ElementTable {
	return &ElementTable{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTable) HandlebarElement() {}

func (element ElementTable) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("table", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("table", attrs)
