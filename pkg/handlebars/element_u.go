...
func U_A(attributes UAttributes, children ...any) *ElementU {
	return &ElementU{
...
func U_E(eventHandlers UEventHandlers, children ...any) *ElementU {
	return &ElementU{
...
func U_AE(attributes UAttributes, eventHandlers UEventHandlers, children ...any) *ElementU {
	return &ElementU{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementU) HandlebarElement() {}

func (element ElementU) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("u", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("u", attrs)
