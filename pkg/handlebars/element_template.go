...
func (e *ElementTemplate) Custom(k, v string) *ElementTemplate {
	e.attrs[k] = v
	return e
}

func (e *ElementTemplate) BindCustom(k string, v bool) *ElementTemplate {
	e.shouldBeComponent = true
	return e
}

func (e ElementTemplate) HandlebarElement() {}

func (e ElementTemplate) GenerateVDOM() interface{} {
	all := append([]any{e.attrs}, e.children...)
	if e.shouldBeComponent {
		return engine.NewComponent("template", all...)
	} else {
		return engine.NewTag("template", all...)
	}
}
...
//   - string-is
func (e *ElementTemplate) Accesskey(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["accesskey"] = v
...
//	*
//	*
func (e *ElementTemplate) Autocapitalize(v string) *ElementTemplate {
	if v == "" {
		return e
	}
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementTemplate) Autofocus(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["autofocus"] = v
...
func (e *ElementTemplate) Class(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["class"] = v
...
//   - true
//   - false
func (e *ElementTemplate) Contenteditable(v string) *ElementTemplate {
	if v == "" {
		return e
	}
...
//	*
//	*
func (e *ElementTemplate) Dir(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["dir"] = v
...
//   - true
//   - false
func (e *ElementTemplate) Draggable(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["draggable"] = v
...
//	*
//	*
func (e *ElementTemplate) Enterkeyhint(v string) *ElementTemplate {
	if v == "" {
		return e
	}
...
//	*
//	*
func (e *ElementTemplate) Hidden(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["hidden"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementTemplate) Id(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["id"] = v
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementTemplate) Inert(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["inert"] = v
...
//	*
//	*
func (e *ElementTemplate) Inputmode(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["inputmode"] = v
...
func (e *ElementTemplate) Is(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["is"] = v
...
func (e *ElementTemplate) Itemid(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["itemid"] = v
...
func (e *ElementTemplate) Itemprop(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["itemprop"] = v
...
// Valid values are constrained to the following:
//   - unordered-set-of-unique-space-separated-tokens
func (e *ElementTemplate) Itemref(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["itemref"] = v
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementTemplate) Itemscope(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["itemscope"] = v
...
//   - unordered-set-of-unique-space-separated-tokens
//   - syntax-url-absolute
func (e *ElementTemplate) Itemtype(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["itemtype"] = v
...
//
// Valid values are constrained to the following:
func (e *ElementTemplate) Lang(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["lang"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementTemplate) Nonce(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["nonce"] = v
...
//	*
//	*
func (e *ElementTemplate) Popover(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["popover"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementTemplate) Slot(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["slot"] = v
...
//   - true
//   - false
func (e *ElementTemplate) Spellcheck(v string) *ElementTemplate {
	if v == "" {
		return e
	}
...
// Valid values are constrained to the following:
func (e *ElementTemplate) Style(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["style"] = v
...
// Valid values are constrained to the following:
//   - valid-integer
func (e *ElementTemplate) Tabindex(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["tabindex"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementTemplate) Title(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["title"] = v
...
//   - yes
//   - no
func (e *ElementTemplate) Translate(v string) *ElementTemplate {
	if v == "" {
		return e
	}
	e.attrs["translate"] = v
