...
func TEMPLATE_A(attributes TemplateAttributes, children ...any) *ElementTemplate {
	return &ElementTemplate{
...
func TEMPLATE_E(eventHandlers TemplateEventHandlers, children ...any) *ElementTemplate {
	return &ElementTemplate{
...
func TEMPLATE_AE(attributes TemplateAttributes, eventHandlers TemplateEventHandlers, children ...any) *ElementTemplate {
	return &ElementTemplate{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTemplate) HandlebarElement() {}

func (element ElementTemplate) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("template", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("template", attrs)
