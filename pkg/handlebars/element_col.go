...
type ElementCol struct {
	...
	EventHandlers ColEventHandlers
...
func COL_A(attributes ColAttributes, children ...any) *ElementCol {
	return &ElementCol{
...
func COL_E(eventHandlers ColEventHandlers, children ...any) *ElementCol {
	return &ElementCol{
...
func COL_AE(attributes ColAttributes, eventHandlers ColEventHandlers, children ...any) *ElementCol {
	return &ElementCol{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementCol) HandlebarElement() {}

func (element ElementCol) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("col", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("col", attrs)
