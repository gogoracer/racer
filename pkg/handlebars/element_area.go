...
type ElementArea struct {
	...
	EventHandlers AreaEventHandlers
...
func AREA_A(attributes AreaAttributes, children ...any) *ElementArea {
	return &ElementArea{
...
func AREA_E(eventHandlers AreaEventHandlers, children ...any) *ElementArea {
	return &ElementArea{
...
func AREA_AE(attributes AreaAttributes, eventHandlers AreaEventHandlers, children ...any) *ElementArea {
	return &ElementArea{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementArea) HandlebarElement() {}

func (element ElementArea) GenerateVDOM() interface{} {
	...
	if element.Attributes.Coords != "" {
		attrs["coords"] = string(element.Attributes.Coords)
	}
	if element.Attributes.Dir != "" {
		attrs["dir"] = string(element.Attributes.Dir)
	}
	if element.Attributes.Download != "" {
		attrs["download"] = string(element.Attributes.Download)
	}
	...
	if element.Attributes.Ping != "" {
		attrs["ping"] = string(element.Attributes.Ping)
	}
	...
	if element.Attributes.Shape != "" {
		attrs["shape"] = string(element.Attributes.Shape)
	}
	...
	if element.Attributes.Target != "" {
		attrs["target"] = string(element.Attributes.Target)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("area", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("area", attrs)
