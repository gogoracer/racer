...
type ElementTime struct {
	...
	EventHandlers TimeEventHandlers
...
func TIME_A(attributes TimeAttributes, children ...any) *ElementTime {
	return &ElementTime{
...
func TIME_E(eventHandlers TimeEventHandlers, children ...any) *ElementTime {
	return &ElementTime{
...
func TIME_AE(attributes TimeAttributes, eventHandlers TimeEventHandlers, children ...any) *ElementTime {
	return &ElementTime{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTime) HandlebarElement() {}

func (element ElementTime) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("time", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("time", attrs)
