...
func LI_A(attributes LiAttributes, children ...any) *ElementLi {
	return &ElementLi{
...
func LI_E(eventHandlers LiEventHandlers, children ...any) *ElementLi {
	return &ElementLi{
...
func LI_AE(attributes LiAttributes, eventHandlers LiEventHandlers, children ...any) *ElementLi {
	return &ElementLi{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementLi) HandlebarElement() {}

func (element ElementLi) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("li", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("li", attrs)
