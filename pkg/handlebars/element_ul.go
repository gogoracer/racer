...
func UL_A(attributes UlAttributes, children ...any) *ElementUl {
	return &ElementUl{
...
func UL_E(eventHandlers UlEventHandlers, children ...any) *ElementUl {
	return &ElementUl{
...
func UL_AE(attributes UlAttributes, eventHandlers UlEventHandlers, children ...any) *ElementUl {
	return &ElementUl{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementUl) HandlebarElement() {}

func (element ElementUl) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("ul", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("ul", attrs)
