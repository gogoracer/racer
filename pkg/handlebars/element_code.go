...
type ElementCode struct {
	...
	EventHandlers CodeEventHandlers
...
func CODE_A(attributes CodeAttributes, children ...any) *ElementCode {
	return &ElementCode{
...
func CODE_E(eventHandlers CodeEventHandlers, children ...any) *ElementCode {
	return &ElementCode{
...
func CODE_AE(attributes CodeAttributes, eventHandlers CodeEventHandlers, children ...any) *ElementCode {
	return &ElementCode{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementCode) HandlebarElement() {}

func (element ElementCode) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("code", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("code", attrs)
