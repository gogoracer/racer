...
type AsideEventHandlers struct {
...
type ElementAside struct {
	...
	EventHandlers AsideEventHandlers
...
func ASIDE_A(attributes AsideAttributes, children ...any) *ElementAside {
	return &ElementAside{
...
func ASIDE_E(eventHandlers AsideEventHandlers, children ...any) *ElementAside {
	return &ElementAside{
...
func ASIDE_AE(attributes AsideAttributes, eventHandlers AsideEventHandlers, children ...any) *ElementAside {
	return &ElementAside{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementAside) HandlebarElement() {}

func (element ElementAside) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("aside", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("aside", attrs)
