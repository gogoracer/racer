...
type TheadEventHandlers struct {
...
type ElementThead struct {
	...
	EventHandlers TheadEventHandlers
...
func THEAD_A(attributes TheadAttributes, children ...any) *ElementThead {
	return &ElementThead{
...
func THEAD_E(eventHandlers TheadEventHandlers, children ...any) *ElementThead {
	return &ElementThead{
...
func THEAD_AE(attributes TheadAttributes, eventHandlers TheadEventHandlers, children ...any) *ElementThead {
	return &ElementThead{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementThead) HandlebarElement() {}

func (element ElementThead) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("thead", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("thead", attrs)
