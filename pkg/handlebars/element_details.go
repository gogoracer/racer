...
type DetailsEventHandlers struct {
...
type ElementDetails struct {
	...
	EventHandlers DetailsEventHandlers
...
func DETAILS_A(attributes DetailsAttributes, children ...any) *ElementDetails {
	return &ElementDetails{
...
func DETAILS_E(eventHandlers DetailsEventHandlers, children ...any) *ElementDetails {
	return &ElementDetails{
...
func DETAILS_AE(attributes DetailsAttributes, eventHandlers DetailsEventHandlers, children ...any) *ElementDetails {
	return &ElementDetails{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementDetails) HandlebarElement() {}

func (element ElementDetails) GenerateVDOM() interface{} {
	...
	if element.Attributes.Open != "" {
		attrs["open"] = string(element.Attributes.Open)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("details", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("details", attrs)
