...
type SmallEventHandlers struct {
...
type ElementSmall struct {
	...
	EventHandlers SmallEventHandlers
...
func SMALL_A(attributes SmallAttributes, children ...any) *ElementSmall {
	return &ElementSmall{
...
func SMALL_E(eventHandlers SmallEventHandlers, children ...any) *ElementSmall {
	return &ElementSmall{
...
func SMALL_AE(attributes SmallAttributes, eventHandlers SmallEventHandlers, children ...any) *ElementSmall {
	return &ElementSmall{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementSmall) HandlebarElement() {}

func (element ElementSmall) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("small", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("small", attrs)
