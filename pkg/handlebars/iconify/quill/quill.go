...
func Mute() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.5 21H8a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1h7l6.586-6.586C22.846 3.154 25 4.047 25 5.828V6m0 8.5v11.672c0 1.781-2.154 2.674-3.414 1.414L17 23M7 28L29 6"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Sound() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12v8a1 1 0 0 0 1 1h7l6.586 6.586c1.26 1.26 3.414.367 3.414-1.414V5.828c0-1.781-2.154-2.674-3.414-1.414L15 11H8a1 1 0 0 0-1 1Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func InlineRight() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m13 24l8-8l-8-8"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Printer() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M27 12h1h-1Zm0 10h-1h1ZM5 22h1h-1Zm0-10H4h1Zm17 11a1 1 0 1 0 0 2v-2Zm-12 2a1 1 0 1 0 0-2v2ZM9 10a1 1 0 1 0 2 0H9Zm1-5V4a1 1 0 0 0-1 1h1Zm12 0h1a1 1 0 0 0-1-1v1Zm-1 5a1 1 0 1 0 2 0h-2ZM9 16a1 1 0 1 0 0 2v-2Zm14 2a1 1 0 1 0 0-2v2Zm-12-1a1 1 0 1 0-2 0h2Zm-1 10H9a1 1 0 0 0 1 1v-1Zm12 0v1a1 1 0 0 0 1-1h-1Zm1-10a1 1 0 1 0-2 0h2Zm3-5v10h2V12h-2ZM6 22V12H4v10h2Zm1-11h18V9H7v2Zm18 12h-3v2h3v-2Zm-15 0H7v2h3v-2Zm-6-1a3 3 0 0 0 3 3v-2a1 1 0 0 1-1-1H4Zm22 0a1 1 0 0 1-1 1v2a3 3 0 0 0 3-3h-2Zm2-10a3 3 0 0 0-3-3v2a1 1 0 0 1 1 1h2ZM6 12a1 1 0 0 1 1-1V9a3 3 0 0 0-3 3h2Zm5-2V5H9v5h2Zm-1-4h12V4H10v2Zm11-1v5h2V5h-2ZM9 18h14v-2H9v2Zm0-1v10h2V17H9Zm1 11h12v-2H10v2Zm13-1V17h-2v10h2Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Skip() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M23 5v22M8 7.586v16.828c0 1.746 2.081 2.653 3.36 1.465l9.062-8.413a2 2 0 0 0 0-2.932L11.36 6.121C10.08 4.933 8 5.84 8 7.586Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Warning() *handlebars.ElementSVG {
	return handlebars.SVG(`<g fill="currentColor"><path d="m4.6 24.047l-.88-.476l.88.476Zm22.8 0l-.879.477l.88-.477Zm-9.641-17.8l.879-.477l-.88.477Zm-3.518 0l.88.476l-.88-.476ZM15 18a1 1 0 1 0 2 0h-2Zm2-6a1 1 0 1 0-2 0h2Zm-.12-5.277l9.641 17.8l1.759-.952l-9.642-17.8l-1.759.952ZM25.641 26H6.358v2h19.284v-2ZM5.48 24.524l9.64-17.801l-1.759-.953L3.72 23.571l1.759.953ZM6.358 26a1 1 0 0 1-.88-1.476L3.72 23.57C2.637 25.571 4.085 28 6.358 28v-2Zm20.163-1.476A1 1 0 0 1 25.642 26v2c2.273 0 3.72-2.43 2.638-4.429l-1.759.953ZM18.638 5.77c-1.135-2.095-4.141-2.095-5.276 0l1.759.953a1 1 0 0 1 1.758 0l1.759-.953ZM17 18v-6h-2v6h2Z"/><path stroke="currentColor" d="M17 21.5a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z"/></g>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Compose() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M27 5L17 15m0-10H8a3 3 0 0 0-3 3v16a3 3 0 0 0 3 3h16a3 3 0 0 0 3-3v-9"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Formatting() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.75 18L10 8L6.25 18m7.5 0L16 24m-2.25-6h-7.5M4 24l2.25-6M28 16c-.333.833-1.8 2-5 2s-3.5 2-3.5 3s.7 3 3.5 3s5-2.5 5-4.5m0-3.5v3.5m0-3.5c0-1.333-.8-4-4-4c-2.4 0-3.667 1.333-4 2m8 5.5V24"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Userneutral() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.5 23h5m4.5-5a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-12 0a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm18-2c0 7.18-5.82 13-13 13S3 23.18 3 16S8.82 3 16 3s13 5.82 13 13Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Vip() *handlebars.ElementSVG {
...
func ArrowUp() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M15 27a1 1 0 1 0 2 0h-2Zm2-21a1 1 0 1 0-2 0h2Zm-1-1l.707-.707a1 1 0 0 0-1.414 0L16 5Zm7.293 8.707a1 1 0 0 0 1.414-1.414l-1.414 1.414Zm-16-1.414a1 1 0 1 0 1.414 1.414l-1.414-1.414ZM17 27V6h-2v21h2ZM15.293 5.707l8 8l1.414-1.414l-8-8l-1.414 1.414Zm0-1.414l-8 8l1.414 1.414l8-8l-1.414-1.414Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func FolderDrafts() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h8m-8 4h22M5 16h6m-6 4h12m-3-4h13m-6 4h6M5 24h2m4 0h4"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Markdown() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 20v-8l-4 4l-4-4v8m12-3.5l3.5 3.5m0 0l3.5-3.5M22.5 20v-9M5 7h22a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Moon() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.294 5A11.19 11.19 0 1 0 27 18.706s-5.723 2.19-10.81-2.897C11.105 10.723 13.295 5 13.295 5Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
...
func TextCenter() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 7h22M9 13h14M5 19h22M9 25h14"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func WarningAlt() *handlebars.ElementSVG {
	return handlebars.SVG(`<g fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 17.5v-8M29 16a13 13 0 1 1-26 0a13 13 0 0 1 26 0Z"/><path fill="currentColor" d="M17 22a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z"/></g>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func FolderOpen() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4 26V8a2 2 0 0 1 2-2h6c3 0 3 3 5 3h7a2 2 0 0 1 2 2v2M4 26l3.783-12.294A1 1 0 0 1 8.739 13H26M4 26h19.523a2 2 0 0 0 1.911-1.412l3.168-10.294A1 1 0 0 0 27.646 13H26"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Inbox() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="m5 16l-.94-.342A1 1 0 0 0 4 16h1Zm22 0h1a1 1 0 0 0-.06-.342L27 16Zm-5.5 0v-1a1 1 0 0 0-.92.606l.92.394Zm-11 0l.92-.394A1 1 0 0 0 10.5 15v1ZM23 5l.94-.342A1 1 0 0 0 23 4v1Zm3 14.5a1 1 0 1 0 2 0h-2ZM9 5V4a1 1 0 0 0-.94.658L9 5ZM4 19.5a1 1 0 1 0 2 0H4ZM27 16h-1v8h2v-7.999L27 16Zm-1 8c0 .425-.223.933-.645 1.355c-.422.422-.93.645-1.355.645v2c1.075 0 2.067-.527 2.77-1.23c.703-.703 1.23-1.695 1.23-2.77h-2ZM8 26c-.425 0-.933-.223-1.355-.645C6.222 24.933 6 24.425 6 24H4c0 1.075.528 2.067 1.23 2.77C5.933 27.473 6.925 28 8 28v-2Zm-2-2v-8H4v8h2Zm10-3.5a6.85 6.85 0 0 0 4.957-2.043a7.718 7.718 0 0 0 1.096-1.384a6.57 6.57 0 0 0 .355-.655l.007-.014l.002-.006l.001-.002v-.001c.001 0 .001-.001-.918-.395c-.92-.394-.919-.394-.919-.395l.001-.002v-.001c.001-.001.001 0 0 0l-.006.014l-.039.08a4.591 4.591 0 0 1-.184.324a5.72 5.72 0 0 1-.81 1.023c-.735.735-1.868 1.457-3.543 1.457v2Zm5.5-3.5H27v-2h-5.5v2ZM5 17h5.5v-2H5v2Zm5.5-1c-.92.394-.919.394-.919.395l.002.003l.002.006l.006.014a2.994 2.994 0 0 0 .09.187a7.718 7.718 0 0 0 1.361 1.852C12.059 19.472 13.676 20.5 16 20.5v-2c-1.675 0-2.808-.723-3.543-1.457a5.718 5.718 0 0 1-.81-1.023a4.591 4.591 0 0 1-.223-.404l-.007-.014s0-.001 0 0v.001l.002.002L10.5 16ZM24 26H8v2h16v-2ZM22.06 5.342l4 11l1.88-.684l-4-11l-1.88.684ZM26 16v3.5h2V16h-2ZM8.06 4.658l-4 11l1.88.684l4-11l-1.88-.684ZM4 16v3.5h2V16H4ZM9 6h14V4H9v2Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func MailList() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 7h14m4 0h4M5 13h10m8 0h4M5 19h14m4 0h4M5 25h12m6 0h4"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Filter() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 7h22M7 13h18M9 19h14m-12 6h10"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func MailUnsub() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M29 9v7m0-7c0-1-1-2-2-2H5C4 7 3 8 3 9m26 0l-11.862 8.212a2 2 0 0 1-2.276 0L3 9m13 16H5c-1 0-2-1-2-2V9m18 17l6-6m2 3a5 5 0 1 1-10 0a5 5 0 0 1 10 0Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Pin() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m14 18l-8 8M20.667 4L28 11.333l-6.38 6.076a2 2 0 0 0-.62 1.448v3.729c0 .89-1.077 1.337-1.707.707L8.707 12.707c-.63-.63-.184-1.707.707-1.707h3.729a2 2 0 0 0 1.448-.62L20.667 4Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Fullscreen() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v3.5a.5.5 0 0 0 .5.5H7M3 11V7.5a.5.5 0 0 1 .5-.5H7m18 0h3.5a.5.5 0 0 1 .5.5V11m0 10v3.5a.5.5 0 0 1-.5.5H25"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func FolderSpam() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.5 12.5c1.5 0 5.5 0 5.5 7M11 5c4 0 8.5 2.8 8.5 6c0 5-9.5 3-9.5 8c0 5.5 17-5 17 4c0 4-8.5 4-13 4c-12 0-11-10.5-3-10.5C15.4 12.1 12.5 7 11 5Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Info() *handlebars.ElementSVG {
	return handlebars.SVG(`<g fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 14h1v9h1m12-7a13 13 0 1 1-26 0a13 13 0 0 1 26 0Z"/><path fill="currentColor" d="M17 9.5a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z"/></g>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func At() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="m23.363 5.286l.567-.824l-.567.824Zm-9.228-2.151l.143.99l-.143-.99ZM5.897 7.819l-.777-.63l.777.63Zm-2.87 9.031l-.997.066l.998-.066Zm22.34 9.554a1 1 0 1 0-1.337-1.486l1.338 1.486ZM22 10.5a1 1 0 1 0-2 0h2Zm-.744 9.896l.8-.6l-.8.6ZM24.5 22v1v-1ZM20 16a5 5 0 0 1-5 5v2a7 7 0 0 0 7-7h-2Zm-5 5a5 5 0 0 1-5-5H8a7 7 0 0 0 7 7v-2Zm-5-5a5 5 0 0 1 5-5V9a7 7 0 0 0-7 7h2Zm5-5a5 5 0 0 1 5 5h2a7 7 0 0 0-7-7v2Zm14.657 1.919c-.735-3.386-2.827-6.463-5.727-8.457l-1.133 1.649c2.491 1.712 4.281 4.356 4.905 7.232l1.955-.424ZM23.93 4.462a14 14 0 0 0-9.939-2.317l.287 1.98a12 12 0 0 1 8.519 1.986l1.133-1.649Zm-9.94-2.317A14 14 0 0 0 5.12 7.19l1.554 1.258a12 12 0 0 1 7.604-4.324l-.287-1.98ZM5.12 7.19a14 14 0 0 0-3.09 9.726l1.996-.131a12 12 0 0 1 2.648-8.337L5.12 7.19Zm-3.09 9.726a14 14 0 0 0 4.333 9.24l1.377-1.451a12 12 0 0 1-3.714-7.92l-1.996.13Zm4.333 9.24a14 14 0 0 0 9.454 3.843l.026-2a12 12 0 0 1-8.103-3.294l-1.377 1.45Zm9.454 3.843a14 14 0 0 0 9.55-3.595l-1.337-1.486a12 12 0 0 1-8.187 3.081l-.026 2ZM20 10.5v9.028h2V10.5h-2Zm.456 10.495c.54.721 1.823 2.005 4.044 2.005v-2a2.97 2.97 0 0 1-2.444-1.204l-1.6 1.2ZM20 19.529c0 .449.1.992.456 1.468l1.6-1.2c-.016-.022-.056-.096-.056-.268h-2ZM24.5 23c1.357 0 2.465-.44 3.314-1.2c.83-.744 1.354-1.737 1.673-2.764c.632-2.034.535-4.434.17-6.117l-1.955.424c.314 1.447.378 3.482-.125 5.1c-.248.8-.616 1.436-1.097 1.866c-.462.414-1.087.691-1.98.691v2Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Alt() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5 9h5.485a1 1 0 0 1 .814.419l9.402 13.162a1 1 0 0 0 .814.419H27M21 9h6"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func FolderDownload() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="m16 21l-.707.707a1 1 0 0 0 1.414 0L16 21Zm1-8a1 1 0 1 0-2 0h2Zm3.207 5.207a1 1 0 0 0-1.414-1.414l1.414 1.414Zm-7-1.414a1 1 0 0 0-1.414 1.414l1.414-1.414ZM29 24V11h-2v13h2ZM26.003 8H17v2h9.003V8ZM17 8c-.208 0-.36-.063-.552-.228c-.245-.21-.442-.477-.805-.912c-.327-.393-.755-.872-1.35-1.24C13.678 5.236 12.933 5 12 5v2c.568 0 .947.138 1.238.318c.311.194.571.465.869.822c.262.315.627.797 1.04 1.15c.463.398 1.06.71 1.853.71V8Zm-5-3H6v2h6V5ZM3 8v16h2V8H3Zm3 19h20v-2H6v2ZM6 5a3 3 0 0 0-3 3h2a1 1 0 0 1 1-1V5Zm23 6c0-1.655-1.338-3-2.997-3v2c.55 0 .997.446.997 1h2ZM3 24a3 3 0 0 0 3 3v-2a1 1 0 0 1-1-1H3Zm24 0a1 1 0 0 1-1 1v2a3 3 0 0 0 3-3h-2Zm-10-3v-8h-2v8h2Zm1.793-4.207l-3.5 3.5l1.414 1.414l3.5-3.5l-1.414-1.414Zm-2.086 3.5l-3.5-3.5l-1.414 1.414l3.5 3.5l1.414-1.414Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Forward() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 13S3 13 3 16s14 3 14 3v3.453c0 1.74 2.069 2.65 3.351 1.475l7.04-6.454a2 2 0 0 0 0-2.948l-7.04-6.454C19.07 6.896 17 7.806 17 9.546V13Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Pause() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.5 7v18m9-18v18"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Remind() *handlebars.ElementSVG {
...
func CogAlt() *handlebars.ElementSVG {
...
func LockWindow() *handlebars.ElementSVG {
...
func Cloudia() *handlebars.ElementSVG {
...
func Nuclear() *handlebars.ElementSVG {
...
func Catchup() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M23 27H7a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v6m0 14h2a2 2 0 0 0 2-2V15a2 2 0 0 0-2-2h-2m0 14V13M9 10h4m-4 7h10M9 21h6"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func CheckmarkDouble() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 17l5 5l12-12m-5 10l2 2l12-12"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func List() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M12 7a1 1 0 1 0 0 2V7Zm15 2a1 1 0 1 0 0-2v2Zm-15 6a1 1 0 1 0 0 2v-2Zm9 2a1 1 0 1 0 0-2v2Zm-9 6a1 1 0 1 0 0 2v-2Zm15 2a1 1 0 1 0 0-2v2ZM12 9h15V7H12v2Zm0 8h9v-2h-9v2Zm0 8h15v-2H12v2Zm-6-1v2a2 2 0 0 0 2-2H6Zm0 0H4a2 2 0 0 0 2 2v-2Zm0 0v-2a2 2 0 0 0-2 2h2Zm0 0h2a2 2 0 0 0-2-2v2Zm0-8v2a2 2 0 0 0 2-2H6Zm0 0H4a2 2 0 0 0 2 2v-2Zm0 0v-2a2 2 0 0 0-2 2h2Zm0 0h2a2 2 0 0 0-2-2v2Zm0-8v2a2 2 0 0 0 2-2H6Zm0 0H4a2 2 0 0 0 2 2V8Zm0 0V6a2 2 0 0 0-2 2h2Zm0 0h2a2 2 0 0 0-2-2v2Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func MailPlus() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M25 28v-8m-4 4h8m0-15v7m0-7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2m26 0l-11.862 8.212a2 2 0 0 1-2.276 0L3 9m0 0v14a2 2 0 0 0 2 2h10"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Sign() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 25h-5L7 15c2-.667 6-4 6-12h6c0 7.6 4 11.167 6 12l-4 10h-5Zm0 0v-6m0-6V3M9 25h14v4H9v-4Zm9-9a2 2 0 1 1-4 0a2 2 0 0 1 4 0Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func SortAlt() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M5 5.015v-1a1 1 0 0 0-1 1h1Zm8 1a1 1 0 1 0 0-2v2ZM4 13a1 1 0 1 0 2 0H4Zm23-7.985h1a1 1 0 0 0-1-1v1ZM26 13a1 1 0 1 0 2 0h-2Zm-7-8.985a1 1 0 1 0 0 2v-2Zm-13.293.278a1 1 0 0 0-1.414 1.414l1.414-1.414Zm22 1.414a1 1 0 0 0-1.414-1.414l1.414 1.414ZM11 26a1 1 0 1 0 0 2v-2Zm10 2a1 1 0 1 0 0-2v2ZM5 6.015h.015v-2H5v2Zm.015 0H13v-2H5.015v2ZM4 5.015V13h2V5.015H4Zm22 0V13h2V5.015h-2Zm1-1h-.015v2H27v-2Zm-.015 0H19v2h7.985v-2ZM16.707 15.293L5.722 4.308L4.308 5.722l10.985 10.985l1.414-1.414ZM5.722 4.308l-.015-.015l-1.414 1.414l.015.015l1.414-1.414Zm10.985 12.4L27.692 5.721l-1.414-1.414l-10.985 10.985l1.414 1.414ZM27.692 5.721l.015-.015l-1.414-1.414l-.015.015l1.414 1.414ZM17 27V16h-2v11h2Zm-6 1h5v-2h-5v2Zm5 0h5v-2h-5v2Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func CalendarAdd() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M15 23.5a1 1 0 1 0 2 0h-2Zm2-7a1 1 0 1 0-2 0h2ZM12.5 19a1 1 0 1 0 0 2v-2Zm7 2a1 1 0 1 0 0-2v2ZM5 11a1 1 0 1 0 0 2v-2Zm22 2a1 1 0 1 0 0-2v2Zm-7-5a1 1 0 1 0 2 0h-2Zm2-4a1 1 0 1 0-2 0h2ZM10 8a1 1 0 1 0 2 0h-2Zm2-4a1 1 0 1 0-2 0h2Zm5 19.5V20h-2v3.5h2Zm0-3.5v-3.5h-2V20h2Zm-4.5 1H16v-2h-3.5v2Zm3.5 0h3.5v-2H16v2ZM7 7h18V5H7v2Zm19 1v18h2V8h-2Zm-1 19H7v2h18v-2ZM6 26V8H4v18h2Zm1 1a1 1 0 0 1-1-1H4a3 3 0 0 0 3 3v-2Zm19-1a1 1 0 0 1-1 1v2a3 3 0 0 0 3-3h-2ZM25 7a1 1 0 0 1 1 1h2a3 3 0 0 0-3-3v2ZM7 5a3 3 0 0 0-3 3h2a1 1 0 0 1 1-1V5Zm-2 8h22v-2H5v2Zm17-5V4h-2v4h2ZM12 8V4h-2v4h2Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func LabelMini() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M24 14.172V10a2 2 0 0 0-2-2h-4.172a2 2 0 0 0-1.414.586l-8 8a2 2 0 0 0 0 2.828l4.172 4.172a2 2 0 0 0 2.828 0l8-8A2 2 0 0 0 24 14.172Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func MailSubbed() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M29 9v7m0-7c0-1-1-2-2-2H5C4 7 3 8 3 9m26 0l-11.862 8.212a2 2 0 0 1-2.276 0L3 9m13 16H5c-1 0-2-1-2-2V9m16.5 14l3 3l6-6"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func MeatballsH() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-width="2" d="M8 17a1 1 0 1 0 0-2a1 1 0 0 0 0 2Zm8 0a1 1 0 1 0 0-2a1 1 0 0 0 0 2Zm8 0a1 1 0 1 0 0-2a1 1 0 0 0 0 2Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Play() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 24.414V7.586c0-1.746 2.081-2.653 3.36-1.465l9.062 8.413a2 2 0 0 1 0 2.932l-9.061 8.413C13.08 27.067 11 26.16 11 24.414Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
...
func Usersad() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.5 24s1-1 2.5-1s2.5 1 2.5 1M29 16c0 7.18-5.82 13-13 13S3 23.18 3 16S8.82 3 16 3s13 5.82 13 13Zm-6 2a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-12 0a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
...
func Off() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M22.5 4.742a13 13 0 1 1-13 0M16 3v10"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func SnoozeTomorrow() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 21h22M7 26h18M10 16a6 6 0 0 1 12 0M6.5 16h-2M9 9L7.5 7.5M16 6V4m7 5l1.485-1.485M28 16h-2.5"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func InboxAdd() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 27H8c-1.5 0-3-1.5-3-3v-8m0 0h5.5s1 3.5 5.5 3.5s5.5-3.5 5.5-3.5H27L23 5H9L5 16Zm20 12v-8m-4 4h8"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Checkmark() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m6.5 17l6 6l13-13"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Clock() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8l4 4m9-4c0 7.18-5.82 13-13 13S3 23.18 3 16S8.82 3 16 3s13 5.82 13 13Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Mail() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="m14.862 17.212l-.57.822l.57-.822Zm2.276 0l.57.822l-.57-.822ZM5 8h22V6H5v2Zm23 1v14h2V9h-2Zm-1 15H5v2h22v-2ZM4 23V9H2v14h2Zm1 1a1 1 0 0 1-1-1H2a3 3 0 0 0 3 3v-2Zm23-1a1 1 0 0 1-1 1v2a3 3 0 0 0 3-3h-2ZM27 8a1 1 0 0 1 1 1h2a3 3 0 0 0-3-3v2ZM5 6a3 3 0 0 0-3 3h2a1 1 0 0 1 1-1V6ZM2.43 9.822l11.862 8.212l1.139-1.644L3.569 8.178L2.431 9.822Zm15.278 8.212l11.861-8.212l-1.138-1.644l-11.862 8.212l1.139 1.644Zm-3.416 0a3 3 0 0 0 3.416 0l-1.139-1.644a1 1 0 0 1-1.138 0l-1.139 1.644Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func PrintAlt() *handlebars.ElementSVG {
...
func TextJustify() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 7h22M5 13h22M5 19h22M5 25h22"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Userhappy() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.5 23s1 1 2.5 1s2.5-1 2.5-1m4.5-5a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-12 0a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm18-2c0 7.18-5.82 13-13 13S3 23.18 3 16S8.82 3 16 3s13 5.82 13 13Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ArrowDown() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M15 26a1 1 0 1 0 2 0h-2Zm2-21a1 1 0 1 0-2 0h2Zm-1 22l-.707.707a1 1 0 0 0 1.414 0L16 27Zm-7.293-8.707a1 1 0 0 0-1.414 1.414l1.414-1.414Zm16 1.414a1 1 0 0 0-1.414-1.414l1.414 1.414ZM17 26V5h-2v21h2Zm-.293.293l-8-8l-1.414 1.414l8 8l1.414-1.414Zm0 1.414l8-8l-1.414-1.414l-8 8l1.414 1.414Z"/>`).
		Custom("viewBox", "0,0,32,32").
		Custom("width", "1em").
		Custom("height", "1em")
}
