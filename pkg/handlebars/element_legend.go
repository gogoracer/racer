...
type LegendEventHandlers struct {
...
type ElementLegend struct {
	...
	EventHandlers LegendEventHandlers
...
func LEGEND_A(attributes LegendAttributes, children ...any) *ElementLegend {
	return &ElementLegend{
...
func LEGEND_E(eventHandlers LegendEventHandlers, children ...any) *ElementLegend {
	return &ElementLegend{
...
func LEGEND_AE(attributes LegendAttributes, eventHandlers LegendEventHandlers, children ...any) *ElementLegend {
	return &ElementLegend{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementLegend) HandlebarElement() {}

func (element ElementLegend) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("legend", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("legend", attrs)
