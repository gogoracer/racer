...
func (e *ElementTextarea) setAttribute(k string, v string, dontEscape ...bool) *ElementTextarea {
...
func (element *ElementTextarea) Rows(v string, dontEscape ...bool) *ElementTextarea {
	element.setAttribute("rows", v, dontEscape...)
	return element
}
...
func (element *ElementTextarea) Wrap(v string, dontEscape ...bool) *ElementTextarea {
	element.setAttribute("wrap", v, dontEscape...)
	return element
}
...
func (element *ElementTextarea) Cols(v string, dontEscape ...bool) *ElementTextarea {
	element.setAttribute("cols", v, dontEscape...)
	return element
}
