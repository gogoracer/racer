...
type TextareaEventHandlers struct {
...
type ElementTextarea struct {
	...
	EventHandlers TextareaEventHandlers
...
func TEXTAREA_A(attributes TextareaAttributes, children ...any) *ElementTextarea {
	return &ElementTextarea{
...
func TEXTAREA_E(eventHandlers TextareaEventHandlers, children ...any) *ElementTextarea {
	return &ElementTextarea{
...
func TEXTAREA_AE(attributes TextareaAttributes, eventHandlers TextareaEventHandlers, children ...any) *ElementTextarea {
	return &ElementTextarea{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTextarea) HandlebarElement() {}

func (element ElementTextarea) GenerateVDOM() interface{} {
	...
	if element.Attributes.Cols != "" {
		attrs["cols"] = string(element.Attributes.Cols)
	}
	...
	if element.Attributes.Rows != "" {
		attrs["rows"] = string(element.Attributes.Rows)
	}
	...
	if element.Attributes.Wrap != "" {
		attrs["wrap"] = string(element.Attributes.Wrap)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("textarea", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("textarea", attrs)
