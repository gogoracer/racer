...
type ButtonEventHandlers struct {
...
func BUTTON_A(attributes ButtonAttributes, children ...any) *ElementButton {
	return &ElementButton{
...
func BUTTON_E(eventHandlers ButtonEventHandlers, children ...any) *ElementButton {
	return &ElementButton{
...
func BUTTON_AE(attributes ButtonAttributes, eventHandlers ButtonEventHandlers, children ...any) *ElementButton {
	return &ElementButton{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementButton) HandlebarElement() {}

func (element ElementButton) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("button", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("button", attrs)
