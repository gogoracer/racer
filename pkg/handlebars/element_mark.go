...
type ElementMark struct {
	...
	EventHandlers MarkEventHandlers
...
func MARK_A(attributes MarkAttributes, children ...any) *ElementMark {
	return &ElementMark{
...
func MARK_E(eventHandlers MarkEventHandlers, children ...any) *ElementMark {
	return &ElementMark{
...
func MARK_AE(attributes MarkAttributes, eventHandlers MarkEventHandlers, children ...any) *ElementMark {
	return &ElementMark{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementMark) HandlebarElement() {}

func (element ElementMark) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("mark", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("mark", attrs)
