...
type ElementCite struct {
	...
	EventHandlers CiteEventHandlers
...
func CITE_A(attributes CiteAttributes, children ...any) *ElementCite {
	return &ElementCite{
...
func CITE_E(eventHandlers CiteEventHandlers, children ...any) *ElementCite {
	return &ElementCite{
...
func CITE_AE(attributes CiteAttributes, eventHandlers CiteEventHandlers, children ...any) *ElementCite {
	return &ElementCite{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementCite) HandlebarElement() {}

func (element ElementCite) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("cite", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("cite", attrs)
