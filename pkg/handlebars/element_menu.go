...
func MENU_A(attributes MenuAttributes, children ...any) *ElementMenu {
	return &ElementMenu{
...
func MENU_E(eventHandlers MenuEventHandlers, children ...any) *ElementMenu {
	return &ElementMenu{
...
func MENU_AE(attributes MenuAttributes, eventHandlers MenuEventHandlers, children ...any) *ElementMenu {
	return &ElementMenu{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementMenu) HandlebarElement() {}

func (element ElementMenu) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("menu", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("menu", attrs)
