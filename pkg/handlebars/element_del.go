...
type ElementDel struct {
	...
	EventHandlers DelEventHandlers
...
func DEL_A(attributes DelAttributes, children ...any) *ElementDel {
	return &ElementDel{
...
func DEL_E(eventHandlers DelEventHandlers, children ...any) *ElementDel {
	return &ElementDel{
...
func DEL_AE(attributes DelAttributes, eventHandlers DelEventHandlers, children ...any) *ElementDel {
	return &ElementDel{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementDel) HandlebarElement() {}

func (element ElementDel) GenerateVDOM() interface{} {
	...
	if element.Attributes.Datetime != "" {
		attrs["datetime"] = string(element.Attributes.Datetime)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("del", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("del", attrs)
