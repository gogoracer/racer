...
type OptionEventHandlers struct {
...
func OPTION_A(attributes OptionAttributes, children ...any) *ElementOption {
	return &ElementOption{
...
func OPTION_E(eventHandlers OptionEventHandlers, children ...any) *ElementOption {
	return &ElementOption{
...
func OPTION_AE(attributes OptionAttributes, eventHandlers OptionEventHandlers, children ...any) *ElementOption {
	return &ElementOption{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementOption) HandlebarElement() {}

func (element ElementOption) GenerateVDOM() interface{} {
	...
	if element.Attributes.Selected != "" {
		attrs["selected"] = string(element.Attributes.Selected)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("option", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("option", attrs)
