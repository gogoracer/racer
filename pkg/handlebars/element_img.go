...
type ElementImg struct {
	...
	EventHandlers ImgEventHandlers
...
func IMG_A(attributes ImgAttributes, children ...any) *ElementImg {
	return &ElementImg{
...
func IMG_E(eventHandlers ImgEventHandlers, children ...any) *ElementImg {
	return &ElementImg{
...
func IMG_AE(attributes ImgAttributes, eventHandlers ImgEventHandlers, children ...any) *ElementImg {
	return &ElementImg{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementImg) HandlebarElement() {}

func (element ElementImg) GenerateVDOM() interface{} {
	...
	if element.Attributes.Decoding != "" {
		attrs["decoding"] = string(element.Attributes.Decoding)
	}
	...
	if element.Attributes.Ismap != "" {
		attrs["ismap"] = string(element.Attributes.Ismap)
	}
	...
	if element.Attributes.Loading != "" {
		attrs["loading"] = string(element.Attributes.Loading)
	}
	...
	if element.Attributes.Srcset != "" {
		attrs["srcset"] = string(element.Attributes.Srcset)
	}
	...
	if element.Attributes.Usemap != "" {
		attrs["usemap"] = string(element.Attributes.Usemap)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("img", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("img", attrs)
