...
func (e *ElementAbbr) Custom(k, v string) *ElementAbbr {
	e.attrs[k] = v
	return e
}

func (e *ElementAbbr) BindCustom(k string, v bool) *ElementAbbr {
	e.shouldBeComponent = true
	return e
}

func (e ElementAbbr) HandlebarElement() {}

func (e ElementAbbr) GenerateVDOM() interface{} {
	all := append([]any{e.attrs}, e.children...)
	if e.shouldBeComponent {
		return engine.NewComponent("abbr", all...)
	} else {
		return engine.NewTag("abbr", all...)
	}
}
...
//   - string-is
func (e *ElementAbbr) Accesskey(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["accesskey"] = v
...
//	*
//	*
func (e *ElementAbbr) Autocapitalize(v string) *ElementAbbr {
	if v == "" {
		return e
	}
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementAbbr) Autofocus(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["autofocus"] = v
...
func (e *ElementAbbr) Class(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["class"] = v
...
//   - true
//   - false
func (e *ElementAbbr) Contenteditable(v string) *ElementAbbr {
	if v == "" {
		return e
	}
...
//	*
//	*
func (e *ElementAbbr) Dir(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["dir"] = v
...
//   - true
//   - false
func (e *ElementAbbr) Draggable(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["draggable"] = v
...
//	*
//	*
func (e *ElementAbbr) Enterkeyhint(v string) *ElementAbbr {
	if v == "" {
		return e
	}
...
//	*
//	*
func (e *ElementAbbr) Hidden(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["hidden"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementAbbr) Id(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["id"] = v
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementAbbr) Inert(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["inert"] = v
...
//	*
//	*
func (e *ElementAbbr) Inputmode(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["inputmode"] = v
...
func (e *ElementAbbr) Is(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["is"] = v
...
func (e *ElementAbbr) Itemid(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["itemid"] = v
...
func (e *ElementAbbr) Itemprop(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["itemprop"] = v
...
// Valid values are constrained to the following:
//   - unordered-set-of-unique-space-separated-tokens
func (e *ElementAbbr) Itemref(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["itemref"] = v
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementAbbr) Itemscope(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["itemscope"] = v
...
//   - unordered-set-of-unique-space-separated-tokens
//   - syntax-url-absolute
func (e *ElementAbbr) Itemtype(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["itemtype"] = v
...
//
// Valid values are constrained to the following:
func (e *ElementAbbr) Lang(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["lang"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementAbbr) Nonce(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["nonce"] = v
...
//	*
//	*
func (e *ElementAbbr) Popover(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["popover"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementAbbr) Slot(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["slot"] = v
...
//   - true
//   - false
func (e *ElementAbbr) Spellcheck(v string) *ElementAbbr {
	if v == "" {
		return e
	}
...
// Valid values are constrained to the following:
func (e *ElementAbbr) Style(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["style"] = v
...
// Valid values are constrained to the following:
//   - valid-integer
func (e *ElementAbbr) Tabindex(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["tabindex"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementAbbr) Title(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["title"] = v
...
//   - yes
//   - no
func (e *ElementAbbr) Translate(v string) *ElementAbbr {
	if v == "" {
		return e
	}
	e.attrs["translate"] = v
