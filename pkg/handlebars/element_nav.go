...
type ElementNav struct {
	...
	EventHandlers NavEventHandlers
...
func NAV_A(attributes NavAttributes, children ...any) *ElementNav {
	return &ElementNav{
...
func NAV_E(eventHandlers NavEventHandlers, children ...any) *ElementNav {
	return &ElementNav{
...
func NAV_AE(attributes NavAttributes, eventHandlers NavEventHandlers, children ...any) *ElementNav {
	return &ElementNav{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementNav) HandlebarElement() {}

func (element ElementNav) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("nav", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("nav", attrs)
