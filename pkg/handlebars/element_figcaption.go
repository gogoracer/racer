...
type FigcaptionEventHandlers struct {
...
type ElementFigcaption struct {
	...
	EventHandlers FigcaptionEventHandlers
...
func FIGCAPTION_A(attributes FigcaptionAttributes, children ...any) *ElementFigcaption {
	return &ElementFigcaption{
...
func FIGCAPTION_E(eventHandlers FigcaptionEventHandlers, children ...any) *ElementFigcaption {
	return &ElementFigcaption{
...
func FIGCAPTION_AE(attributes FigcaptionAttributes, eventHandlers FigcaptionEventHandlers, children ...any) *ElementFigcaption {
	return &ElementFigcaption{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementFigcaption) HandlebarElement() {}

func (element ElementFigcaption) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("figcaption", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("figcaption", attrs)
