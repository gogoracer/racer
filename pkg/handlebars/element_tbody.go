...
type TbodyEventHandlers struct {
...
type ElementTbody struct {
	...
	EventHandlers TbodyEventHandlers
...
func TBODY_A(attributes TbodyAttributes, children ...any) *ElementTbody {
	return &ElementTbody{
...
func TBODY_E(eventHandlers TbodyEventHandlers, children ...any) *ElementTbody {
	return &ElementTbody{
...
func TBODY_AE(attributes TbodyAttributes, eventHandlers TbodyEventHandlers, children ...any) *ElementTbody {
	return &ElementTbody{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTbody) HandlebarElement() {}

func (element ElementTbody) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("tbody", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("tbody", attrs)
