...
type BodyAttributes struct {
	...
	ClientSideLanguagechange string
	...
	ClientSideRejectionhandled string
	...
	ClientSideUnhandledrejection string
...
type BodyEventHandlers struct {

	// <code id="attributes-3:event-auxclick"><a data-x-internal="event-auxclick" href="https://w3c.github.io/uievents/#event-type-auxclick">auxclick</a></code>  event handler
	OnAuxclick engine.EventHandler

	// <code id="attributes-3:event-afterprint"><a href="#event-afterprint">afterprint</a></code>  event handler for  <code id="attributes-3:window"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnAfterprint engine.EventHandler

	// <code id="attributes-3:event-beforematch"><a href="#event-beforematch">beforematch</a></code>  event handler
	OnBeforematch engine.EventHandler

	// <code id="attributes-3:event-beforeprint"><a href="#event-beforeprint">beforeprint</a></code>  event handler for  <code id="attributes-3:window-2"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnBeforeprint engine.EventHandler

	// <code id="attributes-3:event-beforeunload"><a href="#event-beforeunload">beforeunload</a></code>  event handler for  <code id="attributes-3:window-3"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnBeforeunload engine.EventHandler
	...
	// <code id="attributes-3:event-hashchange"><a href="#event-hashchange">hashchange</a></code>  event handler for  <code id="attributes-3:window-4"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnHashchange engine.EventHandler
	...
	// <code id="attributes-3:event-languagechange"><a href="#event-languagechange">languagechange</a></code>  event handler for  <code id="attributes-3:window-5"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnLanguagechange engine.EventHandler
	...
	// <code id="attributes-3:event-message"><a href="#event-message">message</a></code>  event handler for  <code id="attributes-3:window-6"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnMessage engine.EventHandler

	// <code id="attributes-3:event-messageerror"><a href="#event-messageerror">messageerror</a></code>  event handler for  <code id="attributes-3:window-7"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnMessageerror engine.EventHandler
	...
	// <code id="attributes-3:event-offline"><a href="#event-offline">offline</a></code>  event handler for  <code id="attributes-3:window-8"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnOffline engine.EventHandler

	// <code id="attributes-3:event-online"><a href="#event-online">online</a></code>  event handler for  <code id="attributes-3:window-9"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnOnline engine.EventHandler

	// <code id="attributes-3:event-pagehide"><a href="#event-pagehide">pagehide</a></code>  event handler for  <code id="attributes-3:window-10"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnPagehide engine.EventHandler

	// <code id="attributes-3:event-pageshow"><a href="#event-pageshow">pageshow</a></code>  event handler for  <code id="attributes-3:window-11"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnPageshow engine.EventHandler
	...
	// <code id="attributes-3:event-popstate"><a href="#event-popstate">popstate</a></code>  event handler for  <code id="attributes-3:window-12"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnPopstate engine.EventHandler
	...
	// <code id="attributes-3:event-rejectionhandled"><a href="#event-rejectionhandled">rejectionhandled</a></code>  event handler for  <code id="attributes-3:window-13"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnRejectionhandled engine.EventHandler
	...
	// <code id="attributes-3:event-unhandledrejection"><a href="#event-unhandledrejection">unhandledrejection</a></code>  event handler for  <code id="attributes-3:window-15"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnUnhandledrejection engine.EventHandler

	// <code id="attributes-3:event-unload"><a href="#event-unload">unload</a></code>  event handler for  <code id="attributes-3:window-16"><a href="nav-history-apis.html#window">Window</a></code>  object
	OnUnload engine.EventHandler
...
type ElementBody struct {
	...
	EventHandlers BodyEventHandlers
...
func BODY_A(attributes BodyAttributes, children ...any) *ElementBody {
	return &ElementBody{
...
func BODY_E(eventHandlers BodyEventHandlers, children ...any) *ElementBody {
	return &ElementBody{
...
func BODY_AE(attributes BodyAttributes, eventHandlers BodyEventHandlers, children ...any) *ElementBody {
	return &ElementBody{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementBody) HandlebarElement() {}

func (element ElementBody) GenerateVDOM() interface{} {
	...
	if element.EventHandlers.OnAfterprint != nil {
		eventHandlers["afterprint"] = element.EventHandlers.OnAfterprint
	}
	if element.EventHandlers.OnBeforematch != nil {
		eventHandlers["beforematch"] = element.EventHandlers.OnBeforematch
	}
	if element.EventHandlers.OnBeforeprint != nil {
		eventHandlers["beforeprint"] = element.EventHandlers.OnBeforeprint
	}
	if element.EventHandlers.OnBeforeunload != nil {
		eventHandlers["beforeunload"] = element.EventHandlers.OnBeforeunload
	}
	...
	if element.EventHandlers.OnHashchange != nil {
		eventHandlers["hashchange"] = element.EventHandlers.OnHashchange
	}
	...
	if element.EventHandlers.OnLanguagechange != nil {
		eventHandlers["languagechange"] = element.EventHandlers.OnLanguagechange
	}
	...
	if element.EventHandlers.OnMessage != nil {
		eventHandlers["message"] = element.EventHandlers.OnMessage
	}
	if element.EventHandlers.OnMessageerror != nil {
		eventHandlers["messageerror"] = element.EventHandlers.OnMessageerror
	}
	...
	if element.EventHandlers.OnOffline != nil {
		eventHandlers["offline"] = element.EventHandlers.OnOffline
	}
	if element.EventHandlers.OnOnline != nil {
		eventHandlers["online"] = element.EventHandlers.OnOnline
	}
	if element.EventHandlers.OnPagehide != nil {
		eventHandlers["pagehide"] = element.EventHandlers.OnPagehide
	}
	if element.EventHandlers.OnPageshow != nil {
		eventHandlers["pageshow"] = element.EventHandlers.OnPageshow
	}
	...
	if element.EventHandlers.OnPopstate != nil {
		eventHandlers["popstate"] = element.EventHandlers.OnPopstate
	}
	...
	if element.EventHandlers.OnRejectionhandled != nil {
		eventHandlers["rejectionhandled"] = element.EventHandlers.OnRejectionhandled
	}
	...
	if element.EventHandlers.OnStorage != nil {
		eventHandlers["storage"] = element.EventHandlers.OnStorage
	}
	...
	if element.EventHandlers.OnUnhandledrejection != nil {
		eventHandlers["unhandledrejection"] = element.EventHandlers.OnUnhandledrejection
	}
	if element.EventHandlers.OnUnload != nil {
		eventHandlers["unload"] = element.EventHandlers.OnUnload
	}
	...
	if element.Attributes.ClientSideAfterprint != "" {
		attrs["afterprint"] = string(element.Attributes.ClientSideAfterprint)
	}
	...
	if element.Attributes.ClientSideBeforeprint != "" {
		attrs["beforeprint"] = string(element.Attributes.ClientSideBeforeprint)
	}

	if element.Attributes.ClientSideBeforeunload != "" {
		attrs["beforeunload"] = string(element.Attributes.ClientSideBeforeunload)
	}
	...
	if element.Attributes.ClientSideHashchange != "" {
		attrs["hashchange"] = string(element.Attributes.ClientSideHashchange)
	}
	...
	if element.Attributes.ClientSideLanguagechange != "" {
		attrs["languagechange"] = string(element.Attributes.ClientSideLanguagechange)
	}
	...
	if element.Attributes.ClientSideMessage != "" {
		attrs["message"] = string(element.Attributes.ClientSideMessage)
	}

	if element.Attributes.ClientSideMessageerror != "" {
		attrs["messageerror"] = string(element.Attributes.ClientSideMessageerror)
	}
	...
	if element.Attributes.ClientSideOffline != "" {
		attrs["offline"] = string(element.Attributes.ClientSideOffline)
	}

	if element.Attributes.ClientSideOnline != "" {
		attrs["online"] = string(element.Attributes.ClientSideOnline)
	}

	if element.Attributes.ClientSidePagehide != "" {
		attrs["pagehide"] = string(element.Attributes.ClientSidePagehide)
	}

	if element.Attributes.ClientSidePageshow != "" {
		attrs["pageshow"] = string(element.Attributes.ClientSidePageshow)
	}
	...
	if element.Attributes.ClientSidePopstate != "" {
		attrs["popstate"] = string(element.Attributes.ClientSidePopstate)
	}
	...
	if element.Attributes.ClientSideRejectionhandled != "" {
		attrs["rejectionhandled"] = string(element.Attributes.ClientSideRejectionhandled)
	}
	...
	if element.Attributes.ClientSideStorage != "" {
		attrs["storage"] = string(element.Attributes.ClientSideStorage)
	}
	...
	if element.Attributes.ClientSideUnhandledrejection != "" {
		attrs["unhandledrejection"] = string(element.Attributes.ClientSideUnhandledrejection)
	}

	if element.Attributes.ClientSideUnload != "" {
		attrs["unload"] = string(element.Attributes.ClientSideUnload)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("body", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("body", attrs)
