...
func RT_A(attributes RtAttributes, children ...any) *ElementRt {
	return &ElementRt{
...
func RT_E(eventHandlers RtEventHandlers, children ...any) *ElementRt {
	return &ElementRt{
...
func RT_AE(attributes RtAttributes, eventHandlers RtEventHandlers, children ...any) *ElementRt {
	return &ElementRt{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementRt) HandlebarElement() {}

func (element ElementRt) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("rt", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("rt", attrs)
