...
type ElementVar struct {
	...
	EventHandlers VarEventHandlers
...
func VAR_A(attributes VarAttributes, children ...any) *ElementVar {
	return &ElementVar{
...
func VAR_E(eventHandlers VarEventHandlers, children ...any) *ElementVar {
	return &ElementVar{
...
func VAR_AE(attributes VarAttributes, eventHandlers VarEventHandlers, children ...any) *ElementVar {
	return &ElementVar{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementVar) HandlebarElement() {}

func (element ElementVar) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("var", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("var", attrs)
