...
type ElementRuby struct {
	...
	EventHandlers RubyEventHandlers
...
func RUBY_A(attributes RubyAttributes, children ...any) *ElementRuby {
	return &ElementRuby{
...
func RUBY_E(eventHandlers RubyEventHandlers, children ...any) *ElementRuby {
	return &ElementRuby{
...
func RUBY_AE(attributes RubyAttributes, eventHandlers RubyEventHandlers, children ...any) *ElementRuby {
	return &ElementRuby{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementRuby) HandlebarElement() {}

func (element ElementRuby) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("ruby", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("ruby", attrs)
