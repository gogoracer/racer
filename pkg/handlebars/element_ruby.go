...
type ElementRuby struct {
	shouldBeComponent bool
	attrs             map[string]interface{}
	children          []any
}

func RUBY(children ...any) *ElementRuby {
	return &ElementRuby{
		attrs:    map[string]interface{}{},
		children: children,
	}
...
func (e *ElementRuby) Add(children ...any) *ElementRuby {
	e.children = append(e.children, children...)
	return e
}

func (e *ElementRuby) Custom(k, v string) *ElementRuby {
	e.attrs[k] = v
	return e
}

func (e *ElementRuby) BindCustom(k string, v bool) *ElementRuby {
	e.shouldBeComponent = true
	return e
}

func (e ElementRuby) HandlebarElement() {}

func (e ElementRuby) GenerateVDOM() interface{} {
	all := append([]any{e.attrs}, e.children...)
	if e.shouldBeComponent {
		return engine.NewComponent("ruby", all...)
	} else {
		return engine.NewTag("ruby", all...)
	}
}
...
//   - string-is
func (e *ElementRuby) Accesskey(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["accesskey"] = v
...
//	*
//	*
func (e *ElementRuby) Autocapitalize(v string) *ElementRuby {
	if v == "" {
		return e
	}
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementRuby) Autofocus(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["autofocus"] = v
...
func (e *ElementRuby) Class(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["class"] = v
...
//   - true
//   - false
func (e *ElementRuby) Contenteditable(v string) *ElementRuby {
	if v == "" {
		return e
	}
...
//	*
//	*
func (e *ElementRuby) Dir(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["dir"] = v
...
//   - true
//   - false
func (e *ElementRuby) Draggable(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["draggable"] = v
...
//	*
//	*
func (e *ElementRuby) Enterkeyhint(v string) *ElementRuby {
	if v == "" {
		return e
	}
...
//	*
//	*
func (e *ElementRuby) Hidden(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["hidden"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementRuby) Id(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["id"] = v
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementRuby) Inert(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["inert"] = v
...
//	*
//	*
func (e *ElementRuby) Inputmode(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["inputmode"] = v
...
func (e *ElementRuby) Is(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["is"] = v
...
func (e *ElementRuby) Itemid(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["itemid"] = v
...
func (e *ElementRuby) Itemprop(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["itemprop"] = v
...
// Valid values are constrained to the following:
//   - unordered-set-of-unique-space-separated-tokens
func (e *ElementRuby) Itemref(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["itemref"] = v
...
// Valid values are constrained to the following:
//   - boolean-attribute
func (e *ElementRuby) Itemscope(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["itemscope"] = v
...
//   - unordered-set-of-unique-space-separated-tokens
//   - syntax-url-absolute
func (e *ElementRuby) Itemtype(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["itemtype"] = v
...
//
// Valid values are constrained to the following:
func (e *ElementRuby) Lang(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["lang"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementRuby) Nonce(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["nonce"] = v
...
//	*
//	*
func (e *ElementRuby) Popover(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["popover"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementRuby) Slot(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["slot"] = v
...
//   - true
//   - false
func (e *ElementRuby) Spellcheck(v string) *ElementRuby {
	if v == "" {
		return e
	}
...
// Valid values are constrained to the following:
func (e *ElementRuby) Style(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["style"] = v
...
// Valid values are constrained to the following:
//   - valid-integer
func (e *ElementRuby) Tabindex(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["tabindex"] = v
...
// Valid values are constrained to the following:
//   - attribute-text
func (e *ElementRuby) Title(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["title"] = v
...
//   - yes
//   - no
func (e *ElementRuby) Translate(v string) *ElementRuby {
	if v == "" {
		return e
	}
	e.attrs["translate"] = v
...
func (e *ElementRuby) OnAuxclick(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnBeforematch(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnBeforetoggle(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnBlur(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnCancel(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnCanplay(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnCanplaythrough(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnChange(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnClick(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnClose(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnContextlost(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnContextmenu(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnContextrestored(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnCopy(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnCuechange(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnCut(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDblclick(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDrag(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDragend(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDragenter(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDragleave(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDragover(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDragstart(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDrop(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnDurationchange(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnEmptied(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnEnded(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnError(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnFocus(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnFormdata(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnInput(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnInvalid(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnKeydown(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnKeypress(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnKeyup(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnLoad(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnLoadeddata(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnLoadedmetadata(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnLoadstart(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnMousedown(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnMouseenter(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnMouseleave(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnMousemove(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnMouseout(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnMouseover(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnMouseup(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnPaste(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnPause(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnPlay(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnPlaying(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnProgress(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnRatechange(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnReset(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnResize(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnScroll(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnScrollend(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnSecuritypolicyviolation(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnSeeked(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnSeeking(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnSelect(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnSlotchange(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnStalled(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnSubmit(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnSuspend(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnTimeupdate(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnToggle(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnVolumechange(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnWaiting(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
...
func (e *ElementRuby) OnWheel(fn engine.EventHandler) *ElementRuby {
	if fn == nil {
		return e
	}
