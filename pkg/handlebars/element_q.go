...
func Q_A(attributes QAttributes, children ...any) *ElementQ {
	return &ElementQ{
...
func Q_E(eventHandlers QEventHandlers, children ...any) *ElementQ {
	return &ElementQ{
...
func Q_AE(attributes QAttributes, eventHandlers QEventHandlers, children ...any) *ElementQ {
	return &ElementQ{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementQ) HandlebarElement() {}

func (element ElementQ) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("q", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("q", attrs)
