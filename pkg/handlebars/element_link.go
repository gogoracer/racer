...
type LinkAttributes struct {
	...
	Imagesrcset string `json:"imagesrcset"`
...
type ElementLink struct {
	...
	EventHandlers LinkEventHandlers
...
func LINK_A(attributes LinkAttributes, children ...any) *ElementLink {
	return &ElementLink{
...
func LINK_E(eventHandlers LinkEventHandlers, children ...any) *ElementLink {
	return &ElementLink{
...
func LINK_AE(attributes LinkAttributes, eventHandlers LinkEventHandlers, children ...any) *ElementLink {
	return &ElementLink{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementLink) HandlebarElement() {}

func (element ElementLink) GenerateVDOM() interface{} {
	...
	if element.Attributes.As != "" {
		attrs["as"] = string(element.Attributes.As)
	}
	...
	if element.Attributes.Blocking != "" {
		attrs["blocking"] = string(element.Attributes.Blocking)
	}
	if element.Attributes.Class != "" {
		attrs["class"] = string(element.Attributes.Class)
	}
	if element.Attributes.Color != "" {
		attrs["color"] = string(element.Attributes.Color)
	}
	if element.Attributes.Contenteditable != "" {
		attrs["contenteditable"] = string(element.Attributes.Contenteditable)
	}
	if element.Attributes.Crossorigin != "" {
		attrs["crossorigin"] = string(element.Attributes.Crossorigin)
	}
	...
	if element.Attributes.Href != "" {
		attrs["href"] = string(element.Attributes.Href)
	}
	if element.Attributes.Hreflang != "" {
		attrs["hreflang"] = string(element.Attributes.Hreflang)
	}
	if element.Attributes.Id != "" {
		attrs["id"] = string(element.Attributes.Id)
	}
	if element.Attributes.Imagesizes != "" {
		attrs["imagesizes"] = string(element.Attributes.Imagesizes)
	}
	if element.Attributes.Imagesrcset != "" {
		attrs["imagesrcset"] = string(element.Attributes.Imagesrcset)
	}
	...
	if element.Attributes.Integrity != "" {
		attrs["integrity"] = string(element.Attributes.Integrity)
	}
	...
	if element.Attributes.Media != "" {
		attrs["media"] = string(element.Attributes.Media)
	}
	...
	if element.Attributes.Referrerpolicy != "" {
		attrs["referrerpolicy"] = string(element.Attributes.Referrerpolicy)
	}
	if element.Attributes.Rel != "" {
		attrs["rel"] = string(element.Attributes.Rel)
	}
	if element.Attributes.Sizes != "" {
		attrs["sizes"] = string(element.Attributes.Sizes)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("link", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("link", attrs)
