...
type AudioEventHandlers struct {
...
func AUDIO_A(attributes AudioAttributes, children ...any) *ElementAudio {
	return &ElementAudio{
...
func AUDIO_E(eventHandlers AudioEventHandlers, children ...any) *ElementAudio {
	return &ElementAudio{
...
func AUDIO_AE(attributes AudioAttributes, eventHandlers AudioEventHandlers, children ...any) *ElementAudio {
	return &ElementAudio{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementAudio) HandlebarElement() {}

func (element ElementAudio) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("audio", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("audio", attrs)
