...
type MetaAttributes struct {
	...
	//   *
	//   *
	HttpEquiv string `json:"httpEquiv"`
...
type ElementMeta struct {
	...
	EventHandlers MetaEventHandlers
...
func META_A(attributes MetaAttributes, children ...any) *ElementMeta {
	return &ElementMeta{
...
func META_E(eventHandlers MetaEventHandlers, children ...any) *ElementMeta {
	return &ElementMeta{
...
func META_AE(attributes MetaAttributes, eventHandlers MetaEventHandlers, children ...any) *ElementMeta {
	return &ElementMeta{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementMeta) HandlebarElement() {}

func (element ElementMeta) GenerateVDOM() interface{} {
	...
	if element.Attributes.Charset != "" {
		attrs["charset"] = string(element.Attributes.Charset)
	}
	if element.Attributes.Class != "" {
		attrs["class"] = string(element.Attributes.Class)
	}
	if element.Attributes.Content != "" {
		attrs["content"] = string(element.Attributes.Content)
	}
	...
	if element.Attributes.HttpEquiv != "" {
		attrs["http-equiv"] = string(element.Attributes.HttpEquiv)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("meta", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("meta", attrs)
