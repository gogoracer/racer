...
type ElementSpan struct {
	...
	EventHandlers SpanEventHandlers
...
func SPAN_A(attributes SpanAttributes, children ...any) *ElementSpan {
	return &ElementSpan{
...
func SPAN_E(eventHandlers SpanEventHandlers, children ...any) *ElementSpan {
	return &ElementSpan{
...
func SPAN_AE(attributes SpanAttributes, eventHandlers SpanEventHandlers, children ...any) *ElementSpan {
	return &ElementSpan{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementSpan) HandlebarElement() {}

func (element ElementSpan) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("span", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("span", attrs)
