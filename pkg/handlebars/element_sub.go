...
func SUB_A(attributes SubAttributes, children ...any) *ElementSub {
	return &ElementSub{
...
func SUB_E(eventHandlers SubEventHandlers, children ...any) *ElementSub {
	return &ElementSub{
...
func SUB_AE(attributes SubAttributes, eventHandlers SubEventHandlers, children ...any) *ElementSub {
	return &ElementSub{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementSub) HandlebarElement() {}

func (element ElementSub) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("sub", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("sub", attrs)
