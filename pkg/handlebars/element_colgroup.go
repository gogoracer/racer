...
type ColgroupAttributes struct {
...
type ColgroupEventHandlers struct {
...
type ElementColgroup struct {
	...
	EventHandlers ColgroupEventHandlers
...
func COLGROUP_A(attributes ColgroupAttributes, children ...any) *ElementColgroup {
	return &ElementColgroup{
...
func COLGROUP_E(eventHandlers ColgroupEventHandlers, children ...any) *ElementColgroup {
	return &ElementColgroup{
...
func COLGROUP_AE(attributes ColgroupAttributes, eventHandlers ColgroupEventHandlers, children ...any) *ElementColgroup {
	return &ElementColgroup{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementColgroup) HandlebarElement() {}

func (element ElementColgroup) GenerateVDOM() interface{} {
	...
	if element.Attributes.Span != "" {
		attrs["span"] = string(element.Attributes.Span)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("colgroup", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("colgroup", attrs)
