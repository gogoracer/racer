...
func B_A(attributes BAttributes, children ...any) *ElementB {
	return &ElementB{
...
func B_E(eventHandlers BEventHandlers, children ...any) *ElementB {
	return &ElementB{
...
func B_AE(attributes BAttributes, eventHandlers BEventHandlers, children ...any) *ElementB {
	return &ElementB{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementB) HandlebarElement() {}

func (element ElementB) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("b", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("b", attrs)
