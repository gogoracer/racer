...
func DIALOG_A(attributes DialogAttributes, children ...any) *ElementDialog {
	return &ElementDialog{
...
func DIALOG_E(eventHandlers DialogEventHandlers, children ...any) *ElementDialog {
	return &ElementDialog{
...
func DIALOG_AE(attributes DialogAttributes, eventHandlers DialogEventHandlers, children ...any) *ElementDialog {
	return &ElementDialog{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementDialog) HandlebarElement() {}

func (element ElementDialog) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("dialog", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("dialog", attrs)
