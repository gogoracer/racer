...
type ArticleEventHandlers struct {
...
type ElementArticle struct {
	...
	EventHandlers ArticleEventHandlers
...
func ARTICLE_A(attributes ArticleAttributes, children ...any) *ElementArticle {
	return &ElementArticle{
...
func ARTICLE_E(eventHandlers ArticleEventHandlers, children ...any) *ElementArticle {
	return &ElementArticle{
...
func ARTICLE_AE(attributes ArticleAttributes, eventHandlers ArticleEventHandlers, children ...any) *ElementArticle {
	return &ElementArticle{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementArticle) HandlebarElement() {}

func (element ElementArticle) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("article", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("article", attrs)
