...
func DL_A(attributes DlAttributes, children ...any) *ElementDl {
	return &ElementDl{
...
func DL_E(eventHandlers DlEventHandlers, children ...any) *ElementDl {
	return &ElementDl{
...
func DL_AE(attributes DlAttributes, eventHandlers DlEventHandlers, children ...any) *ElementDl {
	return &ElementDl{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementDl) HandlebarElement() {}

func (element ElementDl) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("dl", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("dl", attrs)
