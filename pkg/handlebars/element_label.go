...
type LabelEventHandlers struct {
...
func LABEL_A(attributes LabelAttributes, children ...any) *ElementLabel {
	return &ElementLabel{
...
func LABEL_E(eventHandlers LabelEventHandlers, children ...any) *ElementLabel {
	return &ElementLabel{
...
func LABEL_AE(attributes LabelAttributes, eventHandlers LabelEventHandlers, children ...any) *ElementLabel {
	return &ElementLabel{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementLabel) HandlebarElement() {}

func (element ElementLabel) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("label", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("label", attrs)
