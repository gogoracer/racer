...
func BASE_A(attributes BaseAttributes, children ...any) *ElementBase {
	return &ElementBase{
...
func BASE_E(eventHandlers BaseEventHandlers, children ...any) *ElementBase {
	return &ElementBase{
...
func BASE_AE(attributes BaseAttributes, eventHandlers BaseEventHandlers, children ...any) *ElementBase {
	return &ElementBase{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementBase) HandlebarElement() {}

func (element ElementBase) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("base", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("base", attrs)
