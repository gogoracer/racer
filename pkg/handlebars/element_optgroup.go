...
type OptgroupEventHandlers struct {
...
type ElementOptgroup struct {
	...
	EventHandlers OptgroupEventHandlers
...
func OPTGROUP_A(attributes OptgroupAttributes, children ...any) *ElementOptgroup {
	return &ElementOptgroup{
...
func OPTGROUP_E(eventHandlers OptgroupEventHandlers, children ...any) *ElementOptgroup {
	return &ElementOptgroup{
...
func OPTGROUP_AE(attributes OptgroupAttributes, eventHandlers OptgroupEventHandlers, children ...any) *ElementOptgroup {
	return &ElementOptgroup{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementOptgroup) HandlebarElement() {}

func (element ElementOptgroup) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("optgroup", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("optgroup", attrs)
