...
type FooterEventHandlers struct {
...
type ElementFooter struct {
	...
	EventHandlers FooterEventHandlers
...
func FOOTER_A(attributes FooterAttributes, children ...any) *ElementFooter {
	return &ElementFooter{
...
func FOOTER_E(eventHandlers FooterEventHandlers, children ...any) *ElementFooter {
	return &ElementFooter{
...
func FOOTER_AE(attributes FooterAttributes, eventHandlers FooterEventHandlers, children ...any) *ElementFooter {
	return &ElementFooter{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementFooter) HandlebarElement() {}

func (element ElementFooter) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("footer", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("footer", attrs)
