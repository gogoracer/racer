...
func A_A(attributes AAttributes, children ...any) *ElementA {
	return &ElementA{
...
func A_E(eventHandlers AEventHandlers, children ...any) *ElementA {
	return &ElementA{
...
func A_AE(attributes AAttributes, eventHandlers AEventHandlers, children ...any) *ElementA {
	return &ElementA{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementA) HandlebarElement() {}

func (element ElementA) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("a", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("a", attrs)
