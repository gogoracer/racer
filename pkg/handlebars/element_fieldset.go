...
type FieldsetEventHandlers struct {
...
type ElementFieldset struct {
	...
	EventHandlers FieldsetEventHandlers
...
func FIELDSET_A(attributes FieldsetAttributes, children ...any) *ElementFieldset {
	return &ElementFieldset{
...
func FIELDSET_E(eventHandlers FieldsetEventHandlers, children ...any) *ElementFieldset {
	return &ElementFieldset{
...
func FIELDSET_AE(attributes FieldsetAttributes, eventHandlers FieldsetEventHandlers, children ...any) *ElementFieldset {
	return &ElementFieldset{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementFieldset) HandlebarElement() {}

func (element ElementFieldset) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("fieldset", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("fieldset", attrs)
