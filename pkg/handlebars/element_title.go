...
type TitleEventHandlers struct {
...
type ElementTitle struct {
	...
	EventHandlers TitleEventHandlers
...
func TITLE_A(attributes TitleAttributes, children ...any) *ElementTitle {
	return &ElementTitle{
...
func TITLE_E(eventHandlers TitleEventHandlers, children ...any) *ElementTitle {
	return &ElementTitle{
...
func TITLE_AE(attributes TitleAttributes, eventHandlers TitleEventHandlers, children ...any) *ElementTitle {
	return &ElementTitle{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTitle) HandlebarElement() {}

func (element ElementTitle) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("title", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("title", attrs)
