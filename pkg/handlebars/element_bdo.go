...
type ElementBdo struct {
	...
	EventHandlers BdoEventHandlers
...
func BDO_A(attributes BdoAttributes, children ...any) *ElementBdo {
	return &ElementBdo{
...
func BDO_E(eventHandlers BdoEventHandlers, children ...any) *ElementBdo {
	return &ElementBdo{
...
func BDO_AE(attributes BdoAttributes, eventHandlers BdoEventHandlers, children ...any) *ElementBdo {
	return &ElementBdo{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementBdo) HandlebarElement() {}

func (element ElementBdo) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("bdo", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("bdo", attrs)
