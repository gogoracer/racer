...
func (e *ElementOl) setAttribute(k string, v string, dontEscape ...bool) *ElementOl {
...
func (element *ElementOl) Start(v string, dontEscape ...bool) *ElementOl {
	element.setAttribute("start", v, dontEscape...)
	return element
}
...
func (element *ElementOl) Reversed(v string, dontEscape ...bool) *ElementOl {
	element.setAttribute("reversed", v, dontEscape...)
	return element
}
