...
type StyleEventHandlers struct {
...
type ElementStyle struct {
	...
	EventHandlers StyleEventHandlers
...
func STYLE_A(attributes StyleAttributes, children ...any) *ElementStyle {
	return &ElementStyle{
...
func STYLE_E(eventHandlers StyleEventHandlers, children ...any) *ElementStyle {
	return &ElementStyle{
...
func STYLE_AE(attributes StyleAttributes, eventHandlers StyleEventHandlers, children ...any) *ElementStyle {
	return &ElementStyle{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementStyle) HandlebarElement() {}

func (element ElementStyle) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("style", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("style", attrs)
