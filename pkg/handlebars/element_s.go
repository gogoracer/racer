...
func S_A(attributes SAttributes, children ...any) *ElementS {
	return &ElementS{
...
func S_E(eventHandlers SEventHandlers, children ...any) *ElementS {
	return &ElementS{
...
func S_AE(attributes SAttributes, eventHandlers SEventHandlers, children ...any) *ElementS {
	return &ElementS{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementS) HandlebarElement() {}

func (element ElementS) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("s", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("s", attrs)
