...
type AddressEventHandlers struct {
...
type ElementAddress struct {
	...
	EventHandlers AddressEventHandlers
...
func ADDRESS_A(attributes AddressAttributes, children ...any) *ElementAddress {
	return &ElementAddress{
...
func ADDRESS_E(eventHandlers AddressEventHandlers, children ...any) *ElementAddress {
	return &ElementAddress{
...
func ADDRESS_AE(attributes AddressAttributes, eventHandlers AddressEventHandlers, children ...any) *ElementAddress {
	return &ElementAddress{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementAddress) HandlebarElement() {}

func (element ElementAddress) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("address", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("address", attrs)
