...
type ElementWbr struct {
	...
	EventHandlers WbrEventHandlers
...
func WBR_A(attributes WbrAttributes, children ...any) *ElementWbr {
	return &ElementWbr{
...
func WBR_E(eventHandlers WbrEventHandlers, children ...any) *ElementWbr {
	return &ElementWbr{
...
func WBR_AE(attributes WbrAttributes, eventHandlers WbrEventHandlers, children ...any) *ElementWbr {
	return &ElementWbr{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementWbr) HandlebarElement() {}

func (element ElementWbr) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("wbr", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("wbr", attrs)
