...
func TD_A(attributes TdAttributes, children ...any) *ElementTd {
	return &ElementTd{
...
func TD_E(eventHandlers TdEventHandlers, children ...any) *ElementTd {
	return &ElementTd{
...
func TD_AE(attributes TdAttributes, eventHandlers TdEventHandlers, children ...any) *ElementTd {
	return &ElementTd{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTd) HandlebarElement() {}

func (element ElementTd) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("td", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("td", attrs)
