...
type CanvasEventHandlers struct {
...
func CANVAS_A(attributes CanvasAttributes, children ...any) *ElementCanvas {
	return &ElementCanvas{
...
func CANVAS_E(eventHandlers CanvasEventHandlers, children ...any) *ElementCanvas {
	return &ElementCanvas{
...
func CANVAS_AE(attributes CanvasAttributes, eventHandlers CanvasEventHandlers, children ...any) *ElementCanvas {
	return &ElementCanvas{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementCanvas) HandlebarElement() {}

func (element ElementCanvas) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("canvas", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("canvas", attrs)
