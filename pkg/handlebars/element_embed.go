...
type EmbedEventHandlers struct {
...
func EMBED_A(attributes EmbedAttributes, children ...any) *ElementEmbed {
	return &ElementEmbed{
...
func EMBED_E(eventHandlers EmbedEventHandlers, children ...any) *ElementEmbed {
	return &ElementEmbed{
...
func EMBED_AE(attributes EmbedAttributes, eventHandlers EmbedEventHandlers, children ...any) *ElementEmbed {
	return &ElementEmbed{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementEmbed) HandlebarElement() {}

func (element ElementEmbed) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("embed", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("embed", attrs)
