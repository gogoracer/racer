...
type FigureEventHandlers struct {
...
type ElementFigure struct {
	...
	EventHandlers FigureEventHandlers
...
func FIGURE_A(attributes FigureAttributes, children ...any) *ElementFigure {
	return &ElementFigure{
...
func FIGURE_E(eventHandlers FigureEventHandlers, children ...any) *ElementFigure {
	return &ElementFigure{
...
func FIGURE_AE(attributes FigureAttributes, eventHandlers FigureEventHandlers, children ...any) *ElementFigure {
	return &ElementFigure{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementFigure) HandlebarElement() {}

func (element ElementFigure) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("figure", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("figure", attrs)
