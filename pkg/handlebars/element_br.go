...
func BR_A(attributes BrAttributes, children ...any) *ElementBr {
	return &ElementBr{
...
func BR_E(eventHandlers BrEventHandlers, children ...any) *ElementBr {
	return &ElementBr{
...
func BR_AE(attributes BrAttributes, eventHandlers BrEventHandlers, children ...any) *ElementBr {
	return &ElementBr{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementBr) HandlebarElement() {}

func (element ElementBr) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("br", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("br", attrs)
