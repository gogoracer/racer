...
func RP_A(attributes RpAttributes, children ...any) *ElementRp {
	return &ElementRp{
...
func RP_E(eventHandlers RpEventHandlers, children ...any) *ElementRp {
	return &ElementRp{
...
func RP_AE(attributes RpAttributes, eventHandlers RpEventHandlers, children ...any) *ElementRp {
	return &ElementRp{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementRp) HandlebarElement() {}

func (element ElementRp) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("rp", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("rp", attrs)
