...
type HeaderEventHandlers struct {
...
type ElementHeader struct {
	...
	EventHandlers HeaderEventHandlers
...
func HEADER_A(attributes HeaderAttributes, children ...any) *ElementHeader {
	return &ElementHeader{
...
func HEADER_E(eventHandlers HeaderEventHandlers, children ...any) *ElementHeader {
	return &ElementHeader{
...
func HEADER_AE(attributes HeaderAttributes, eventHandlers HeaderEventHandlers, children ...any) *ElementHeader {
	return &ElementHeader{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementHeader) HandlebarElement() {}

func (element ElementHeader) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("header", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("header", attrs)
