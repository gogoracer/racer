...
func HR_A(attributes HrAttributes, children ...any) *ElementHr {
	return &ElementHr{
...
func HR_E(eventHandlers HrEventHandlers, children ...any) *ElementHr {
	return &ElementHr{
...
func HR_AE(attributes HrAttributes, eventHandlers HrEventHandlers, children ...any) *ElementHr {
	return &ElementHr{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementHr) HandlebarElement() {}

func (element ElementHr) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("hr", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("hr", attrs)
