...
func TR_A(attributes TrAttributes, children ...any) *ElementTr {
	return &ElementTr{
...
func TR_E(eventHandlers TrEventHandlers, children ...any) *ElementTr {
	return &ElementTr{
...
func TR_AE(attributes TrAttributes, eventHandlers TrEventHandlers, children ...any) *ElementTr {
	return &ElementTr{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementTr) HandlebarElement() {}

func (element ElementTr) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("tr", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("tr", attrs)
