...
type SummaryEventHandlers struct {
...
type ElementSummary struct {
	...
	EventHandlers SummaryEventHandlers
...
func SUMMARY_A(attributes SummaryAttributes, children ...any) *ElementSummary {
	return &ElementSummary{
...
func SUMMARY_E(eventHandlers SummaryEventHandlers, children ...any) *ElementSummary {
	return &ElementSummary{
...
func SUMMARY_AE(attributes SummaryAttributes, eventHandlers SummaryEventHandlers, children ...any) *ElementSummary {
	return &ElementSummary{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementSummary) HandlebarElement() {}

func (element ElementSummary) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("summary", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("summary", attrs)
