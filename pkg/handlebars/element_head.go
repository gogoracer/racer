...
type ElementHead struct {
	...
	EventHandlers HeadEventHandlers
...
func HEAD_A(attributes HeadAttributes, children ...any) *ElementHead {
	return &ElementHead{
...
func HEAD_E(eventHandlers HeadEventHandlers, children ...any) *ElementHead {
	return &ElementHead{
...
func HEAD_AE(attributes HeadAttributes, eventHandlers HeadEventHandlers, children ...any) *ElementHead {
	return &ElementHead{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementHead) HandlebarElement() {}

func (element ElementHead) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("head", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("head", attrs)
