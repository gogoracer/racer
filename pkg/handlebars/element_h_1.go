...
func H1_A(attributes H1Attributes, children ...any) *ElementH1 {
	return &ElementH1{
...
func H1_E(eventHandlers H1EventHandlers, children ...any) *ElementH1 {
	return &ElementH1{
...
func H1_AE(attributes H1Attributes, eventHandlers H1EventHandlers, children ...any) *ElementH1 {
	return &ElementH1{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementH1) HandlebarElement() {}

func (element ElementH1) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("h1", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("h1", attrs)
