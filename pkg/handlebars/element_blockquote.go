...
type BlockquoteAttributes struct {
...
type BlockquoteEventHandlers struct {
...
type ElementBlockquote struct {
	...
	EventHandlers BlockquoteEventHandlers
...
func BLOCKQUOTE_A(attributes BlockquoteAttributes, children ...any) *ElementBlockquote {
	return &ElementBlockquote{
...
func BLOCKQUOTE_E(eventHandlers BlockquoteEventHandlers, children ...any) *ElementBlockquote {
	return &ElementBlockquote{
...
func BLOCKQUOTE_AE(attributes BlockquoteAttributes, eventHandlers BlockquoteEventHandlers, children ...any) *ElementBlockquote {
	return &ElementBlockquote{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementBlockquote) HandlebarElement() {}

func (element ElementBlockquote) GenerateVDOM() interface{} {
	...
	if element.Attributes.Cite != "" {
		attrs["cite"] = string(element.Attributes.Cite)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("blockquote", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("blockquote", attrs)
