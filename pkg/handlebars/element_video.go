...
type VideoEventHandlers struct {
...
func VIDEO_A(attributes VideoAttributes, children ...any) *ElementVideo {
	return &ElementVideo{
...
func VIDEO_E(eventHandlers VideoEventHandlers, children ...any) *ElementVideo {
	return &ElementVideo{
...
func VIDEO_AE(attributes VideoAttributes, eventHandlers VideoEventHandlers, children ...any) *ElementVideo {
	return &ElementVideo{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementVideo) HandlebarElement() {}

func (element ElementVideo) GenerateVDOM() interface{} {
	...
	if element.Attributes.Autoplay != "" {
		attrs["autoplay"] = string(element.Attributes.Autoplay)
	}
	...
	if element.Attributes.Controls != "" {
		attrs["controls"] = string(element.Attributes.Controls)
	}
	...
	if element.Attributes.Loop != "" {
		attrs["loop"] = string(element.Attributes.Loop)
	}
	if element.Attributes.Muted != "" {
		attrs["muted"] = string(element.Attributes.Muted)
	}
	if element.Attributes.Nonce != "" {
		attrs["nonce"] = string(element.Attributes.Nonce)
	}
	if element.Attributes.Playsinline != "" {
		attrs["playsinline"] = string(element.Attributes.Playsinline)
	}
	if element.Attributes.Popover != "" {
		attrs["popover"] = string(element.Attributes.Popover)
	}
	if element.Attributes.Poster != "" {
		attrs["poster"] = string(element.Attributes.Poster)
	}
	if element.Attributes.Preload != "" {
		attrs["preload"] = string(element.Attributes.Preload)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("video", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("video", attrs)
