...
func P_A(attributes PAttributes, children ...any) *ElementP {
	return &ElementP{
...
func P_E(eventHandlers PEventHandlers, children ...any) *ElementP {
	return &ElementP{
...
func P_AE(attributes PAttributes, eventHandlers PEventHandlers, children ...any) *ElementP {
	return &ElementP{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementP) HandlebarElement() {}

func (element ElementP) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("p", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("p", attrs)
