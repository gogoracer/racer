...
func MAP_A(attributes MapAttributes, children ...any) *ElementMap {
	return &ElementMap{
...
func MAP_E(eventHandlers MapEventHandlers, children ...any) *ElementMap {
	return &ElementMap{
...
func MAP_AE(attributes MapAttributes, eventHandlers MapEventHandlers, children ...any) *ElementMap {
	return &ElementMap{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementMap) HandlebarElement() {}

func (element ElementMap) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("map", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("map", attrs)
