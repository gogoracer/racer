...
func DT_A(attributes DtAttributes, children ...any) *ElementDt {
	return &ElementDt{
...
func DT_E(eventHandlers DtEventHandlers, children ...any) *ElementDt {
	return &ElementDt{
...
func DT_AE(attributes DtAttributes, eventHandlers DtEventHandlers, children ...any) *ElementDt {
	return &ElementDt{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementDt) HandlebarElement() {}

func (element ElementDt) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("dt", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("dt", attrs)
