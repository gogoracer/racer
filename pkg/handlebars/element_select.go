...
type SelectEventHandlers struct {
...
func SELECT_A(attributes SelectAttributes, children ...any) *ElementSelect {
	return &ElementSelect{
...
func SELECT_E(eventHandlers SelectEventHandlers, children ...any) *ElementSelect {
	return &ElementSelect{
...
func SELECT_AE(attributes SelectAttributes, eventHandlers SelectEventHandlers, children ...any) *ElementSelect {
	return &ElementSelect{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementSelect) HandlebarElement() {}

func (element ElementSelect) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("select", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("select", attrs)
