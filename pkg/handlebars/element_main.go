...
func MAIN_A(attributes MainAttributes, children ...any) *ElementMain {
	return &ElementMain{
...
func MAIN_E(eventHandlers MainEventHandlers, children ...any) *ElementMain {
	return &ElementMain{
...
func MAIN_AE(attributes MainAttributes, eventHandlers MainEventHandlers, children ...any) *ElementMain {
	return &ElementMain{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementMain) HandlebarElement() {}

func (element ElementMain) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("main", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("main", attrs)
