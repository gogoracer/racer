...
type IframeEventHandlers struct {
...
func IFRAME_A(attributes IframeAttributes, children ...any) *ElementIframe {
	return &ElementIframe{
...
func IFRAME_E(eventHandlers IframeEventHandlers, children ...any) *ElementIframe {
	return &ElementIframe{
...
func IFRAME_AE(attributes IframeAttributes, eventHandlers IframeEventHandlers, children ...any) *ElementIframe {
	return &ElementIframe{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementIframe) HandlebarElement() {}

func (element ElementIframe) GenerateVDOM() interface{} {
	...
	if element.Attributes.Allow != "" {
		attrs["allow"] = string(element.Attributes.Allow)
	}
	if element.Attributes.Allowfullscreen != "" {
		attrs["allowfullscreen"] = string(element.Attributes.Allowfullscreen)
	}
	...
	if element.Attributes.Sandbox != "" {
		attrs["sandbox"] = string(element.Attributes.Sandbox)
	}
	...
	if element.Attributes.Srcdoc != "" {
		attrs["srcdoc"] = string(element.Attributes.Srcdoc)
	}
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("iframe", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("iframe", attrs)
