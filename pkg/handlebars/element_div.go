...
type ElementDiv struct {
	...
	EventHandlers DivEventHandlers
...
func DIV_A(attributes DivAttributes, children ...any) *ElementDiv {
	return &ElementDiv{
...
func DIV_E(eventHandlers DivEventHandlers, children ...any) *ElementDiv {
	return &ElementDiv{
...
func DIV_AE(attributes DivAttributes, eventHandlers DivEventHandlers, children ...any) *ElementDiv {
	return &ElementDiv{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementDiv) HandlebarElement() {}

func (element ElementDiv) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("div", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("div", attrs)
