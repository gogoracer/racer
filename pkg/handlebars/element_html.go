...
type ElementHtml struct {
	...
	EventHandlers HtmlEventHandlers
...
func HTML_A(attributes HtmlAttributes, children ...any) *ElementHtml {
	return &ElementHtml{
...
func HTML_E(eventHandlers HtmlEventHandlers, children ...any) *ElementHtml {
	return &ElementHtml{
...
func HTML_AE(attributes HtmlAttributes, eventHandlers HtmlEventHandlers, children ...any) *ElementHtml {
	return &ElementHtml{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementHtml) HandlebarElement() {}

func (element ElementHtml) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("html", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("html", attrs)
