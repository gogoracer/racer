...
type SourceEventHandlers struct {
...
type ElementSource struct {
	...
	EventHandlers SourceEventHandlers
...
func SOURCE_A(attributes SourceAttributes, children ...any) *ElementSource {
	return &ElementSource{
...
func SOURCE_E(eventHandlers SourceEventHandlers, children ...any) *ElementSource {
	return &ElementSource{
...
func SOURCE_AE(attributes SourceAttributes, eventHandlers SourceEventHandlers, children ...any) *ElementSource {
	return &ElementSource{
		Attributes:    attributes,
		EventHandlers: eventHandlers,
		Children:      children,
...
func (element ElementSource) HandlebarElement() {}

func (element ElementSource) GenerateVDOM() interface{} {
	...
	if len(eventHandlers) == 0 {
		tag := engine.NewTag("source", attrs)
		virtualDOMElement = tag
	} else {
		component := engine.NewComponent("source", attrs)
