...
func Adobe() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M2 22.041a.998.998 0 0 1-1-1V2.959a1 1 0 0 1 1-1h7.425a1 1 0 0 1 .925 1.38L2.925 21.42a1 1 0 0 1-.925.62Zm14.244 0H13.63a1 1 0 0 1-.891-.546l-1.522-2.99H8.963a1 1 0 0 1-.928-1.372L11.094 9.5a1 1 0 0 1 .928-.628h.01a1 1 0 0 1 .926.646l4.221 11.168a1 1 0 0 1-.935 1.354ZM22 21.809a.999.999 0 0 1-.921-.613L13.56 3.346a1 1 0 0 1 .921-1.387H22a1 1 0 0 1 1 1v17.85a1 1 0 0 1-.802.98a1.049 1.049 0 0 1-.198.02Z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AdobeAlt() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M14.483 2.959L22 20.809V2.959ZM2 2.959V21.04L9.425 2.96Zm7.069 14.324h2.784l1.748 3.433h2.537l-4.1-10.843Z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Airplay() *goggles.ElementSVG {
	return goggles.SVG(`<rect width="20" height="15" x="2" y="3" fill="currentColor" opacity=".5" rx="3"/><path fill="currentColor" d="M16 21H8a1 1 0 0 1-.832-1.555l4-6a1.038 1.038 0 0 1 1.664 0l4 6A1 1 0 0 1 16 21Z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Align() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-8 4H3a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2zm8 8H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-8-4H3a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z" opacity=".5"/><path fill="currentColor" d="M19 14.666a1 1 0 0 1-1-1v-3.333a1 1 0 0 1 1.64-.768l2 1.667a1 1 0 0 1 0 1.536l-2 1.667a.999.999 0 0 1-.64.231Z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignAlt() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M10 5H7a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zM21 5h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm0 4h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2zm-4 4h-3a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignCenter() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2zm4 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignCenterJustify() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 5H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H7a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignJustify() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignLeft() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H3a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2zm4 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-4 4H3a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignLeftJustify() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 5H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-6 4H3a1 1 0 0 1 0-2h12a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignLetterRight() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 4H10a1 1 0 0 1 0-2h11a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 6H11a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignRight() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 7H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H7a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H7a1 1 0 0 1 0-2h14a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func AlignRightJustify() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 5H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm0 4H11a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
...
func CircleLayer() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M15 2a6.998 6.998 0 0 0-6.88 5.737a6 6 0 0 1 8.143 8.143A6.997 6.997 0 0 0 15 2z" opacity=".25"/><circle cx="7" cy="17" r="5" fill="currentColor"/><path fill="currentColor" d="M11 7a6 6 0 0 0-5.97 5.406a4.997 4.997 0 0 1 6.564 6.564A6 6 0 0 0 11 7z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ClinicMedical() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 12a.996.996 0 0 1-.664-.252L12 4.338l-8.336 7.41a1 1 0 0 1-1.328-1.496l9-8a.999.999 0 0 1 1.328 0l9 8A1 1 0 0 1 21 12Z" opacity=".5"/><path fill="currentColor" d="M14 13h-1v-1a1 1 0 0 0-2 0v1h-1a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h1a1 1 0 0 0 0-2Z"/><path fill="currentColor" d="m12 4.338l-8 7.111V21a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-9.551ZM14 15h-1v1a1 1 0 0 1-2 0v-1h-1a1 1 0 0 1 0-2h1v-1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 0 2Z" opacity=".25"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Clock() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M12 6a1 1 0 0 1 1 1v4.422l2.098 1.212a1 1 0 0 1-1 1.732l-2.598-1.5A1.005 1.005 0 0 1 11 12V7a1 1 0 0 1 1-1Z"/><path fill="currentColor" d="M2 12A10 10 0 1 0 12 2A10 10 0 0 0 2 12Zm9-5a1 1 0 0 1 2 0v4.422l2.098 1.212a1 1 0 0 1-1 1.732l-2.598-1.5A1.005 1.005 0 0 1 11 12Z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ClockEight() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M12 6a1 1 0 0 0-1 1v4.422l-2.098 1.212a1 1 0 0 0 1 1.732l2.598-1.5A1.005 1.005 0 0 0 13 12V7a1 1 0 0 0-1-1Z"/><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm1 10a1.005 1.005 0 0 1-.5.866l-2.598 1.5a1 1 0 0 1-1-1.732L11 11.422V7a1 1 0 0 1 2 0Z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ClockFive() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M12 6a1.003 1.003 0 0 1 1 1v4.73l1.6 2.77a1 1 0 1 1-1.73 1l-1.69-2.93A.999.999 0 0 1 11 12V7a1.003 1.003 0 0 1 1-1Z"/><path fill="currentColor" d="M2 12A10 10 0 1 0 12 2A10 10 0 0 0 2 12Zm9-5a1 1 0 0 1 2 0v4.73l1.6 2.77a1 1 0 1 1-1.73 1l-1.69-2.93A.999.999 0 0 1 11 12Z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ClockNine() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M12 6a1 1 0 0 0-1 1v4H9a1 1 0 0 0 0 2h3a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1Z"/><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm1 10a1 1 0 0 1-1 1H9a1 1 0 0 1 0-2h2V7a1 1 0 0 1 2 0Z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ClockSeven() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M12 6a1.003 1.003 0 0 0-1 1v4.73L9.4 14.5a1 1 0 1 0 1.73 1l1.69-2.93A.999.999 0 0 0 13 12V7a1.003 1.003 0 0 0-1-1Z"/><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm1 10a.999.999 0 0 1-.18.57l-1.69 2.93a1 1 0 1 1-1.73-1l1.6-2.77V7a1 1 0 0 1 2 0Z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ClockTen() *goggles.ElementSVG {
	return goggles.SVG(`<circle cx="12" cy="12" r="10" fill="currentColor" opacity=".5"/><path fill="currentColor" d="M13 7a1 1 0 0 0-2 0v3.268l-1.098-.634a1 1 0 0 0-1 1.732l2.598 1.5A1.014 1.014 0 0 0 13 12Z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ClockThree() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M12 6a1 1 0 0 1 1 1v4h2a1 1 0 0 1 0 2h-3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1Z"/><path fill="currentColor" d="M2 12A10 10 0 1 0 12 2A10 10 0 0 0 2 12Zm9-5a1 1 0 0 1 2 0v4h2a1 1 0 0 1 0 2h-3a1 1 0 0 1-1-1Z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ClockTwo() *goggles.ElementSVG {
	return goggles.SVG(`<circle cx="12" cy="12" r="10" fill="currentColor" opacity=".5"/><path fill="currentColor" d="M11 7a1 1 0 0 1 2 0v3.268l1.098-.634a1 1 0 0 1 1 1.732l-2.598 1.5A1.014 1.014 0 0 1 11 12Z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Columns() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M11 2h2v20h-2z" opacity=".25"/><path fill="currentColor" d="M3 2h8v20H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z"/><path fill="currentColor" d="M13 2h8a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1h-8V2z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Comment() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M12 22H3a1 1 0 0 1-.707-1.707l1.964-1.964A10 10 0 1 1 12 22Z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func CommentAlt() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M21 22a.999.999 0 0 1-.707-.293L16.586 18H5a3.003 3.003 0 0 1-3-3V5a3.003 3.003 0 0 1 3-3h14a3.003 3.003 0 0 1 3 3v16a1 1 0 0 1-1 1Z" opacity=".5"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
...
func HtmlThree() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m17.476 6.123l-.534 5.994l.002.033l-.002.074v-.001l-.38 4.192l-.041.372L12 18.037v.001l-.004.003l-4.512-1.258l-.306-3.465h2.213l.157 1.762l2.453.665l-.001.001l2.461-.675l.261-2.869H9.576l-.044-.485l-.101-1.136l-.052-.611h5.538l.202-2.231H6.682l-.044-.485l-.1-1.137l-.053-.61h11.044z" opacity=".5"/><path fill="currentColor" d="m3.195 2l1.602 17.994L11.989 22l7.212-2.013L20.805 2H3.195zm14.281 4.123l-.534 5.994l.002.033l-.002.074v-.001l-.38 4.192l-.041.372L12 18.037v.001l-.004.003l-4.512-1.258l-.306-3.465h2.213l.157 1.762l2.453.665l-.001.001l2.461-.675l.261-2.869H9.576l-.044-.485l-.101-1.136l-.052-.611h5.538l.202-2.231H6.682l-.044-.485l-.1-1.137l-.053-.61h11.044l-.053.616z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
func HtmlThreeAlt() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M11.99 22a1.001 1.001 0 0 1-.268-.037l-6.473-1.805a1 1 0 0 1-.728-.874L3.08 3.09A1 1 0 0 1 4.075 2h15.85a1 1 0 0 1 .996 1.089l-1.443 16.188a.999.999 0 0 1-.728.874l-6.491 1.812a1.001 1.001 0 0 1-.269.037Z" opacity=".5"/><path fill="currentColor" d="M16.777 6.325A1 1 0 0 0 16.04 6H7.96a1 1 0 1 0 0 2h6.987l-.177 2H10a1 1 0 0 0 0 2h4.592l-.264 2.977l-2.328.528l-2.328-.53l-.096-1.064a1 1 0 0 0-1.992.178l.16 1.79a1.001 1.001 0 0 0 .775.887l3.26.74a1.019 1.019 0 0 0 .443 0l3.26-.74a1.001 1.001 0 0 0 .774-.887l.78-8.79a1.001 1.001 0 0 0-.259-.764Z"/>`).
		Custom("viewBox", "0,0,24,24").
		Custom("width", "1em").
		Custom("height", "1em")
}
