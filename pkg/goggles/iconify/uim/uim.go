...
func ArrowDownRight() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M17 18H7a1 1 0 0 1 0-2h9V7a1 1 0 0 1 2 0v10a1 1 0 0 1-1 1Z"/><path fill="currentColor" d="M17 18a.997.997 0 0 1-.707-.293l-10-10a1 1 0 0 1 1.414-1.414l10 10A1 1 0 0 1 17 18Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
...
func AngleLeft() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M14.121 17.243a.997.997 0 0 1-.707-.293l-4.242-4.243a1 1 0 0 1 0-1.414l4.242-4.243a1 1 0 0 1 1.414 1.414L11.293 12l3.535 3.536a1 1 0 0 1-.707 1.707Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func BatteryEmpty() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M21 14a1 1 0 0 1-1-1v-2a1 1 0 0 1 2 0v2a1 1 0 0 1-1 1zm-4 3H4a2.002 2.002 0 0 1-2-2V9a2.002 2.002 0 0 1 2-2h13a2.002 2.002 0 0 1 2 2v6a2.002 2.002 0 0 1-2 2z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func Redo() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M19.875 8.5h-4.5a1 1 0 0 1 0-2h3.5V3a1 1 0 0 1 2 0v4.5a1 1 0 0 1-1 1Z"/><path fill="currentColor" d="M12 22a10 10 0 1 1 8.651-15.001a1 1 0 0 1-1.73 1.002A7.99 7.99 0 1 0 20 12a1 1 0 0 1 2 0a10.011 10.011 0 0 1-10 10Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func Analytics() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M5 22a1 1 0 0 1-1-1v-8a1 1 0 0 1 2 0v8a1 1 0 0 1-1 1zm5 0a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1zm5 0a1 1 0 0 1-1-1V9a1 1 0 0 1 2 0v12a1 1 0 0 1-1 1zm5 0a1 1 0 0 1-1-1v-4a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func AngleRight() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M9.879 17.243a1 1 0 0 1-.707-1.707L12.707 12L9.172 8.464a1 1 0 0 1 1.414-1.414l4.242 4.243a1 1 0 0 1 0 1.414l-4.242 4.243a.997.997 0 0 1-.707.293Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func AngleRightB() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M9.172 18.657a1 1 0 0 1-.707-1.707l4.95-4.95l-4.95-4.95a1 1 0 0 1 1.414-1.414l5.656 5.657a1 1 0 0 1 0 1.414L9.88 18.364a.997.997 0 0 1-.707.293Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func Favorite() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M17.562 21.56a1 1 0 0 1-.465-.116L12 18.764l-5.097 2.68a1 1 0 0 1-1.45-1.053l.973-5.676l-4.124-4.02a1 1 0 0 1 .554-1.705l5.699-.828l2.549-5.164a1.04 1.04 0 0 1 1.793 0l2.548 5.164l5.699.828a1 1 0 0 1 .554 1.705l-4.124 4.02l.974 5.676a1 1 0 0 1-.985 1.169Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func AndroidAlt() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="m16.2 4.7l.7-1.2c.2-.5.1-1.1-.4-1.4c-.5-.2-1.1-.1-1.4.4l-.6 1.1c.6.2 1.2.6 1.7 1.1zm-8.4 0c.5-.5 1-.8 1.7-1.1l-.6-1.1c-.3-.5-.9-.6-1.4-.4s-.6.9-.4 1.4l.7 1.2zM6 9h12v2H6z"/><path fill="currentColor" d="M12 3C8.7 3 6 5.7 6 9h12c0-3.3-2.7-6-6-6zm9 6c-.6 0-1 .4-1 1v4c0 .6.4 1 1 1s1-.4 1-1v-4c0-.6-.4-1-1-1zM3 9c-.6 0-1 .4-1 1v4c0 .6.4 1 1 1s1-.4 1-1v-4c0-.6-.4-1-1-1zm3 8c0 .6.4 1 1 1h2v3c0 .6.4 1 1 1s1-.4 1-1v-3h2v3c0 .6.4 1 1 1s1-.4 1-1v-3h2c.6 0 1-.4 1-1v-6H6v6z" opacity=".5"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func ArrowDownLeft() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M17 18H7a1 1 0 0 1-1-1V7a1 1 0 0 1 2 0v9h9a1 1 0 0 1 0 2Z"/><path fill="currentColor" d="M7 18a1 1 0 0 1-.707-1.707l10-10a1 1 0 0 1 1.414 1.414l-10 10A.997.997 0 0 1 7 18Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func DocumentLayoutLeft() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M21 8h-8a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2zm0 4h-8a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2z" opacity=".5"/><rect width="8" height="8" x="2" y="4" fill="currentColor" rx="1"/><path fill="currentColor" d="M21 16H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-8 4H3a1 1 0 0 1 0-2h10a1 1 0 0 1 0 2z" opacity=".5"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func ObjectGroup() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M11 10h5a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1z" opacity=".5"/><path fill="currentColor" d="M10 11a1 1 0 0 1 1-1h3V8a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h2v-3zM4 22a2 2 0 1 1 0-4a2 2 0 0 1 0 4zM4 6a2 2 0 1 1 0-4a2 2 0 0 1 0 4zm16 0a2 2 0 1 1 0-4a2 2 0 0 1 0 4zm0 16a2 2 0 1 1 0-4a2 2 0 0 1 0 4z"/><path fill="currentColor" d="M18.278 5a1.936 1.936 0 0 1 0-2H5.722a1.936 1.936 0 0 1 0 2h12.556zM20 18a1.98 1.98 0 0 1 1 .278V5.722a1.936 1.936 0 0 1-2 0v12.556A1.98 1.98 0 0 1 20 18zM4 18a1.98 1.98 0 0 1 1 .278V5.722a1.936 1.936 0 0 1-2 0v12.556A1.98 1.98 0 0 1 4 18zm14.278 1H5.722a1.936 1.936 0 0 1 0 2h12.556a1.936 1.936 0 0 1 0-2z" opacity=".25"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func WebSection() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M14 2h2v20h-2z" opacity=".25"/><path fill="currentColor" d="M3 2h11v20H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z" opacity=".5"/><path fill="currentColor" d="M16 2h5a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1h-5V2z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
...
func ArrowUpLeft() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M7 18a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h10a1 1 0 0 1 0 2H8v9a1 1 0 0 1-1 1Z"/><path fill="currentColor" d="M17 18a.997.997 0 0 1-.707-.293l-10-10a1 1 0 0 1 1.414-1.414l10 10A1 1 0 0 1 17 18Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func Check() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M9.84 17.08a.997.997 0 0 1-.707-.293l-3.84-3.84a1 1 0 1 1 1.414-1.414l3.133 3.133l7.453-7.453a1 1 0 0 1 1.414 1.414l-8.16 8.16a.997.997 0 0 1-.707.293Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
...
func VectorSquareAlt() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M4 22a2 2 0 1 1 2-2a2.003 2.003 0 0 1-2 2zm0-2.002zM4 6a2 2 0 1 1 2-2a2.003 2.003 0 0 1-2 2zm0-2.002zM20 6a2 2 0 1 1 2-2a2.003 2.003 0 0 1-2 2zm0-2.002zM20 22a2 2 0 1 1 2-2a2.003 2.003 0 0 1-2 2zm0-2.002z"/><rect width="10" height="10" x="7" y="7" fill="currentColor" opacity=".5" rx="1"/><path fill="currentColor" d="M18.278 5a1.936 1.936 0 0 1 0-2H5.722a1.936 1.936 0 0 1 0 2zM20 18a1.976 1.976 0 0 1 1 .278V5.722a1.936 1.936 0 0 1-2 0v12.556A1.976 1.976 0 0 1 20 18zM4 18a1.976 1.976 0 0 1 1 .278V5.722a1.936 1.936 0 0 1-2 0v12.556A1.976 1.976 0 0 1 4 18zm14.278 1H5.722a1.936 1.936 0 0 1 0 2h12.556a1.936 1.936 0 0 1 0-2z" opacity=".25"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func WrapText() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M21 7.167H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2zm-12 10H3a1 1 0 1 1 0-2h6a1 1 0 0 1 0 2z" opacity=".5"/><path fill="currentColor" d="M18.5 17.167H15a1 1 0 0 1 0-2h3.5a1.5 1.5 0 0 0 0-3H3a1 1 0 0 1 0-2h15.5a3.5 3.5 0 1 1 0 7Z"/><path fill="currentColor" d="M14.999 18.833a.995.995 0 0 1-.639-.231l-2-1.666a1 1 0 0 1 0-1.538l2-1.667a1 1 0 0 1 1.28 1.538l-1.078.898l1.078.897a1 1 0 0 1-.641 1.769Z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func ShieldPlus() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M14 11h-1v-1a1 1 0 0 0-2 0v1h-1a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h1a1 1 0 0 0 0-2Z"/><path fill="currentColor" d="M19.63 3.65a1.002 1.002 0 0 0-.835-.203a7.985 7.985 0 0 1-6.223-1.267a.999.999 0 0 0-1.144 0a7.98 7.98 0 0 1-6.223 1.267A1 1 0 0 0 4 4.427v7.456a9.019 9.019 0 0 0 3.769 7.324l3.65 2.607a1 1 0 0 0 1.162 0l3.65-2.607A9.017 9.017 0 0 0 20 11.883V4.426a1.001 1.001 0 0 0-.37-.776ZM14 13h-1v1a1 1 0 0 1-2 0v-1h-1a1 1 0 0 1 0-2h1v-1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 0 2Z" opacity=".5"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func WebSectionAlt() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M9.9 2H8.1A2.584 2.584 0 0 0 8 3v18c-.032.337.002.676.1 1h1.8c.098-.324.132-.663.1-1V3a2.584 2.584 0 0 0-.1-1z" opacity=".25"/><path fill="currentColor" d="M3 2h5v20H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z"/><path fill="currentColor" d="M10 2h11a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H10V2z" opacity=".5"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func Box() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M20.23 7.24L12 12L3.77 7.24a1.98 1.98 0 0 1 .7-.71L11 2.76c.62-.35 1.38-.35 2 0l6.53 3.77c.29.173.531.418.7.71z" opacity=".25"/><path fill="currentColor" d="M12 12v9.5a2.09 2.09 0 0 1-.91-.21L4.5 17.48a2.003 2.003 0 0 1-1-1.73v-7.5a2.06 2.06 0 0 1 .27-1.01L12 12z" opacity=".5"/><path fill="currentColor" d="M20.5 8.25v7.5a2.003 2.003 0 0 1-1 1.73l-6.62 3.82c-.275.13-.576.198-.88.2V12l8.23-4.76c.175.308.268.656.27 1.01z"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func FlipH() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M21 13H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2Z" opacity=".25"/><path fill="currentColor" d="m12 21l5-5H7l5 5z"/><path fill="currentColor" d="M12 22a.997.997 0 0 1-.707-.293l-5-5A1 1 0 0 1 7 15h10a1 1 0 0 1 .707 1.707l-5 5A.997.997 0 0 1 12 22Zm-2.586-5L12 19.586L14.586 17Z"/><path fill="currentColor" d="M12 4a.99.99 0 0 1-.92-1.38a1.03 1.03 0 0 1 .21-.33a.998.998 0 0 1 1.09-.21a1.034 1.034 0 0 1 .33.21A1.052 1.052 0 0 1 13 3a.838.838 0 0 1-.08.38a1.171 1.171 0 0 1-.21.33A.992.992 0 0 1 12 4zM8.79 6.21a1.008 1.008 0 0 1 0-1.42a1.007 1.007 0 0 1 1.42 0a1.008 1.008 0 0 1 0 1.42a1.027 1.027 0 0 1-.71.29a1.026 1.026 0 0 1-.71-.29zM7 9a.99.99 0 0 1-1-1a1 1 0 0 1 1.71-.71A1.052 1.052 0 0 1 8 8a.99.99 0 0 1-1 1zm5.67-1a.997.997 0 0 1 1-1a1.003 1.003 0 0 1 1 1a1.003 1.003 0 0 1-1 1a.997.997 0 0 1-1-1zM9.33 8a1.003 1.003 0 0 1 1-1a.997.997 0 0 1 1 1a.997.997 0 0 1-1 1a1.003 1.003 0 0 1-1-1zM17 9a.99.99 0 0 1-1-1a1 1 0 1 1 2 0a.99.99 0 0 1-1 1zm-3.21-2.79a1.008 1.008 0 0 1 0-1.42a1.007 1.007 0 0 1 1.42 0a1.008 1.008 0 0 1 0 1.42a1.027 1.027 0 0 1-.71.29a1.026 1.026 0 0 1-.71-.29z" opacity=".5"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func Hospital() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M12.5 14.5h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2zm0 4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2zm-5-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2zm0 4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2zm10-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2zm0 4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2z" opacity=".5"/><path fill="currentColor" d="M13.5 7H13v-.5a1 1 0 0 0-2 0V7h-.5a1 1 0 0 0 0 2h.5v.5a1 1 0 0 0 2 0V9h.5a1 1 0 0 0 0-2Z"/><path fill="currentColor" d="M21.5 6.5h-3v-4a1 1 0 0 0-1-1h-11a1 1 0 0 0-1 1v4h-3a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h19a1 1 0 0 0 1-1v-14a1 1 0 0 0-1-1Zm-14 12h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2Zm0-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2Zm5 4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2Zm0-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2Zm1-5.5H13v.5a1 1 0 0 1-2 0V9h-.5a1 1 0 0 1 0-2h.5v-.5a1 1 0 0 1 2 0V7h.5a1 1 0 0 1 0 2Zm4 9.5h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2Zm0-4h-1a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2Z" opacity=".25"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
func KeyholeSquare() *handlebars.ElementSVG {
    return handlebars.SVG(`<path fill="currentColor" d="M14 10a2 2 0 1 0-3 1.723V15a1 1 0 0 0 2 0v-3.277A1.991 1.991 0 0 0 14 10Z"/><path fill="currentColor" d="M19 2H5a3.003 3.003 0 0 0-3 3v14a3.003 3.003 0 0 0 3 3h14a3.003 3.003 0 0 0 3-3V5a3.003 3.003 0 0 0-3-3Zm-6 9.723V15a1 1 0 0 1-2 0v-3.277a2 2 0 1 1 2 0Z" opacity=".5"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
...
func EllipsisV() *handlebars.ElementSVG {
    return handlebars.SVG(`<circle cx="12" cy="12" r="2" fill="currentColor"/><circle cx="12" cy="5" r="2" fill="currentColor"/><circle cx="12" cy="19" r="2" fill="currentColor"/>`).
        Custom("viewBox","0,0,24,24").
        Custom("width","1em").
        Custom("height","1em")
}
