...
func Link() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M24 30.2c0 .2.1.5.1.8c0 1.4-.5 2.6-1.5 3.6l-2 2c-1 1-2.2 1.5-3.6 1.5c-2.8 0-5.1-2.3-5.1-5.1c0-1.4.5-2.6 1.5-3.6l2-2c1-1 2.2-1.5 3.6-1.5c.3 0 .5 0 .8.1l1.5-1.5c-.7-.3-1.5-.4-2.3-.4c-1.9 0-3.6.7-4.9 2l-2 2c-1.3 1.3-2 3-2 4.9c0 3.8 3.1 6.9 6.9 6.9c1.9 0 3.6-.7 4.9-2l2-2c1.3-1.3 2-3 2-4.9c0-.8-.1-1.6-.4-2.3L24 30.2zm9-20.1c-1.9 0-3.6.7-4.9 2l-2 2c-1.3 1.3-2 3-2 4.9c0 .8.1 1.6.4 2.3l1.5-1.5c0-.2-.1-.5-.1-.8c0-1.4.5-2.6 1.5-3.6l2-2c1-1 2.2-1.5 3.6-1.5c2.8 0 5.1 2.3 5.1 5.1c0 1.4-.5 2.6-1.5 3.6l-2 2c-1 1-2.2 1.5-3.6 1.5c-.3 0-.5 0-.8-.1l-1.5 1.5c.7.3 1.5.4 2.3.4c1.9 0 3.6-.7 4.9-2l2-2c1.3-1.3 2-3 2-4.9c0-3.8-3.1-6.9-6.9-6.9z"/><path fill="currentColor" d="M20 31c-.3 0-.5-.1-.7-.3c-.4-.4-.4-1 0-1.4l10-10c.4-.4 1-.4 1.4 0s.4 1 0 1.4l-10 10c-.2.2-.4.3-.7.3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ScGithub() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" fill-rule="evenodd" d="M25 10c-8.3 0-15 6.7-15 15c0 6.6 4.3 12.2 10.3 14.2c.8.1 1-.3 1-.7v-2.6c-4.2.9-5.1-2-5.1-2c-.7-1.7-1.7-2.2-1.7-2.2c-1.4-.9.1-.9.1-.9c1.5.1 2.3 1.5 2.3 1.5c1.3 2.3 3.5 1.6 4.4 1.2c.1-1 .5-1.6 1-2c-3.3-.4-6.8-1.7-6.8-7.4c0-1.6.6-3 1.5-4c-.2-.4-.7-1.9.1-4c0 0 1.3-.4 4.1 1.5c1.2-.3 2.5-.5 3.8-.5c1.3 0 2.6.2 3.8.5c2.9-1.9 4.1-1.5 4.1-1.5c.8 2.1.3 3.6.1 4c1 1 1.5 2.4 1.5 4c0 5.8-3.5 7-6.8 7.4c.5.5 1 1.4 1 2.8v4.1c0 .4.3.9 1 .7c6-2 10.2-7.6 10.2-14.2C40 16.7 33.3 10 25 10z" clip-rule="evenodd"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Search() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M23 36c-7.2 0-13-5.8-13-13s5.8-13 13-13s13 5.8 13 13s-5.8 13-13 13zm0-24c-6.1 0-11 4.9-11 11s4.9 11 11 11s11-4.9 11-11s-4.9-11-11-11z"/><path fill="currentColor" d="m32.682 31.267l8.98 8.98l-1.414 1.414l-8.98-8.98z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Minus() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M16 24h18v2H16z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Paperclip() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M13.8 39.6c-1.5 0-3.1-.6-4.2-1.8c-2.3-2.3-2.3-6.1 0-8.5l17-17c3.1-3.1 8.2-3.1 11.3 0c3.1 3.1 3.1 8.2 0 11.3L25.1 36.4L23.7 35l12.7-12.7c2.3-2.3 2.3-6.1 0-8.5c-2.3-2.3-6.1-2.3-8.5 0l-17 17c-.8.8-1.2 1.8-1.2 2.8c0 1.1.4 2.1 1.2 2.8c1.6 1.6 4.1 1.6 5.7 0l12.7-12.7c.8-.8.8-2 0-2.8c-.8-.8-2-.8-2.8 0L18 29.3l-1.4-1.4l8.5-8.5c1.6-1.6 4.1-1.6 5.7 0c1.6 1.6 1.6 4.1 0 5.7L18 37.8c-1.1 1.2-2.7 1.8-4.2 1.8z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Pencil() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="m9.6 40.4l2.5-9.9L27 15.6l7.4 7.4l-14.9 14.9l-9.9 2.5zm4.3-8.9l-1.5 6.1l6.1-1.5L31.6 23L27 18.4L13.9 31.5z"/><path fill="currentColor" d="M17.8 37.3c-.6-2.5-2.6-4.5-5.1-5.1l.5-1.9c3.2.8 5.7 3.3 6.5 6.5l-1.9.5z"/><path fill="currentColor" d="m29.298 19.287l1.414 1.414l-13.01 13.02l-1.414-1.41zM11 39l2.9-.7c-.3-1.1-1.1-1.9-2.2-2.2L11 39zm24-16.6L27.6 15l3-3l.5.1c3.6.5 6.4 3.3 6.9 6.9l.1.5l-3.1 2.9zM30.4 15l4.6 4.6l.9-.9c-.5-2.3-2.3-4.1-4.6-4.6l-.9.9z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ScSkype() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M38 27.3c.1-.8.2-1.6.2-2.4c0-1.8-.3-3.5-1-5.1c-.7-1.6-1.6-3-2.8-4.2c-1.2-1.2-2.6-2.2-4.2-2.8c-1.6-.7-3.4-1-5.1-1c-.8 0-1.7.1-2.5.2c-1.1-.6-2.4-.9-3.7-.9c-2.1 0-4.1.8-5.5 2.3c-1.5 1.5-2.3 3.4-2.3 5.5c0 1.3.3 2.6 1 3.8c-.1.7-.2 1.5-.2 2.3c0 1.8.3 3.5 1 5.1c.7 1.6 1.6 3 2.8 4.2c1.2 1.2 2.6 2.2 4.2 2.8c1.6.7 3.4 1 5.1 1c.8 0 1.6-.1 2.3-.2c1.2.7 2.5 1 3.9 1c2.1 0 4.1-.8 5.5-2.3c1.5-1.5 2.3-3.4 2.3-5.5c0-1.3-.3-2.6-1-3.8zM25.1 33c-4.7 0-6.8-2.3-6.8-4c0-.9.7-1.5 1.6-1.5c2 0 1.5 2.9 5.2 2.9c1.9 0 3-1 3-2.1c0-.6-.3-1.4-1.6-1.7l-4.2-1c-3.4-.8-4-2.7-4-4.4c0-3.6 3.3-4.9 6.5-4.9c2.9 0 6.3 1.6 6.3 3.7c0 .9-.8 1.4-1.7 1.4c-1.7 0-1.4-2.4-4.9-2.4c-1.7 0-2.7.8-2.7 1.9c0 1.1 1.4 1.5 2.5 1.7l3.1.7c3.4.8 4.2 2.7 4.2 4.6c.1 2.9-2.1 5.1-6.5 5.1z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ScTumblr() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M30.9 32.4c-.5.2-1.5.5-2.3.5c-2.2.1-2.7-1.6-2.7-2.8v-8.7h5.6v-4.2H26V10h-4.1c-.1 0-.2.1-.2.2c-.2 2.2-1.3 6-5.5 7.5v3.6H19v9.1c0 3.1 2.3 7.6 8.4 7.5c2.1 0 4.3-.9 4.8-1.6l-1.3-3.9z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Undo() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M25 38c-5.1 0-9.7-3-11.8-7.6l1.8-.8c1.8 3.9 5.7 6.4 10 6.4c6.1 0 11-4.9 11-11s-4.9-11-11-11c-4.6 0-8.5 2.8-10.1 7.3l-1.9-.7c1.9-5.2 6.6-8.6 12-8.6c7.2 0 13 5.8 13 13s-5.8 13-13 13z"/><path fill="currentColor" d="M20 22h-8v-8h2v6h6z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ArrowRight() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="m24.7 34.7l-1.4-1.4l8.3-8.3l-8.3-8.3l1.4-1.4l9.7 9.7z"/><path fill="currentColor" d="M16 24h17v2H16z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Chart() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M18 36h-2V26h-4v10h-2V24h8zm10 0h-2V20h-4v16h-2V18h8zm10 0h-2V14h-4v22h-2V12h8zM8 36h32v2H8z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Eye() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M25 36C13.5 36 8.3 25.9 8.1 25.4c-.1-.3-.1-.6 0-.9C8.3 24.1 13.5 14 25 14s16.7 10.1 16.9 10.6c.1.3.1.6 0 .9c-.2.4-5.4 10.5-16.9 10.5zM10.1 25c1.1 1.9 5.9 9 14.9 9s13.7-7.1 14.9-9c-1.1-1.9-5.9-9-14.9-9s-13.7 7.1-14.9 9z"/><path fill="currentColor" d="M25 34c-5 0-9-4-9-9s4-9 9-9s9 4 9 9s-4 9-9 9zm0-16c-3.9 0-7 3.1-7 7s3.1 7 7 7s7-3.1 7-7s-3.1-7-7-7z"/><path fill="currentColor" d="M25 30c-2.8 0-5-2.2-5-5c0-.6.4-1 1-1s1 .4 1 1c0 1.7 1.3 3 3 3s3-1.3 3-3s-1.3-3-3-3c-.6 0-1-.4-1-1s.4-1 1-1c2.8 0 5 2.2 5 5s-2.2 5-5 5z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Lock() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M34 23h-2v-4c0-3.9-3.1-7-7-7s-7 3.1-7 7v4h-2v-4c0-5 4-9 9-9s9 4 9 9v4z"/><path fill="currentColor" d="M33 40H17c-1.7 0-3-1.3-3-3V25c0-1.7 1.3-3 3-3h16c1.7 0 3 1.3 3 3v12c0 1.7-1.3 3-3 3zM17 24c-.6 0-1 .4-1 1v12c0 .6.4 1 1 1h16c.6 0 1-.4 1-1V25c0-.6-.4-1-1-1H17z"/><circle cx="25" cy="28" r="2" fill="currentColor"/><path fill="currentColor" d="M25.5 28h-1l-1 6h3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Retweet() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M38 35h-2V17c0-.6-.4-1-1-1H18v-2h17c1.7 0 3 1.3 3 3v18z"/><path fill="currentColor" d="m37 36.5l-6.8-7.8l1.6-1.4l5.2 6.2l5.2-6.2l1.6 1.4zm-5-.5H15c-1.7 0-3-1.3-3-3V15h2v18c0 .6.4 1 1 1h17v2z"/><path fill="currentColor" d="M18.2 22.7L13 16.5l-5.2 6.2l-1.6-1.4l6.8-7.8l6.8 7.8z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ShareGoogle() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M15 30c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5zm0-8c-1.7 0-3 1.3-3 3s1.3 3 3 3s3-1.3 3-3s-1.3-3-3-3zm20-2c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5zm0-8c-1.7 0-3 1.3-3 3s1.3 3 3 3s3-1.3 3-3s-1.3-3-3-3zm0 28c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5zm0-8c-1.7 0-3 1.3-3 3s1.3 3 3 3s3-1.3 3-3s-1.3-3-3-3z"/><path fill="currentColor" d="m19.007 25.885l12.88 6.44l-.895 1.788l-12.88-6.44zm11.986-10l.894 1.79l-12.88 6.438l-.894-1.79z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ChevronRight() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="m22.7 34.7l-1.4-1.4l8.3-8.3l-8.3-8.3l1.4-1.4l9.7 9.7z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Location() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="m25 42.5l-.8-.9C23.7 41.1 12 27.3 12 19c0-7.2 5.8-13 13-13s13 5.8 13 13c0 8.3-11.7 22.1-12.2 22.7l-.8.8zM25 8c-6.1 0-11 4.9-11 11c0 6.4 8.4 17.2 11 20.4c2.6-3.2 11-14 11-20.4c0-6.1-4.9-11-11-11z"/><path fill="currentColor" d="M25 24c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5zm0-8c-1.7 0-3 1.3-3 3s1.3 3 3 3s3-1.3 3-3s-1.3-3-3-3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Navicon() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M10 12h30v4H10zm0 10h30v4H10zm0 10h30v4H10z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ScInstagram() *handlebars.ElementSVG {
	return handlebars.SVG(`<g fill="currentColor" fill-rule="evenodd"><path d="M25 12c-3.53 0-3.973.015-5.36.078c-1.384.063-2.329.283-3.156.604a6.372 6.372 0 0 0-2.302 1.5a6.372 6.372 0 0 0-1.5 2.303c-.321.826-.54 1.771-.604 3.155C12.015 21.027 12 21.47 12 25c0 3.53.015 3.973.078 5.36c.063 1.384.283 2.329.604 3.155c.333.855.777 1.58 1.5 2.303a6.372 6.372 0 0 0 2.302 1.5c.827.32 1.772.54 3.156.604c1.387.063 1.83.078 5.36.078c3.53 0 3.973-.015 5.36-.078c1.384-.063 2.329-.283 3.155-.604a6.371 6.371 0 0 0 2.303-1.5a6.372 6.372 0 0 0 1.5-2.303c.32-.826.54-1.771.604-3.155c.063-1.387.078-1.83.078-5.36c0-3.53-.015-3.973-.078-5.36c-.063-1.384-.283-2.329-.605-3.155a6.372 6.372 0 0 0-1.499-2.303a6.371 6.371 0 0 0-2.303-1.5c-.826-.32-1.771-.54-3.155-.604C28.973 12.015 28.53 12 25 12m0 2.342c3.471 0 3.882.014 5.253.076c1.267.058 1.956.27 2.414.448c.607.236 1.04.517 1.495.972c.455.455.736.888.972 1.495c.178.458.39 1.146.448 2.414c.062 1.37.076 1.782.076 5.253s-.014 3.882-.076 5.253c-.058 1.268-.27 1.956-.448 2.414a4.028 4.028 0 0 1-.972 1.495a4.027 4.027 0 0 1-1.495.972c-.458.178-1.147.39-2.414.448c-1.37.062-1.782.076-5.253.076s-3.883-.014-5.253-.076c-1.268-.058-1.956-.27-2.414-.448a4.027 4.027 0 0 1-1.495-.972a4.03 4.03 0 0 1-.972-1.495c-.178-.458-.39-1.146-.448-2.414c-.062-1.37-.076-1.782-.076-5.253s.014-3.882.076-5.253c.058-1.268.27-1.956.448-2.414c.236-.607.517-1.04.972-1.495a4.028 4.028 0 0 1 1.495-.972c.458-.178 1.146-.39 2.414-.448c1.37-.062 1.782-.076 5.253-.076"/><path d="M25 18a7 7 0 1 0 0 14a7 7 0 0 0 0-14m0 11.5a4.5 4.5 0 1 1 0-9a4.5 4.5 0 0 1 0 9m8.7-11.4a1.6 1.6 0 1 1-3.2 0a1.6 1.6 0 0 1 3.2 0"/></g>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ArrowLeft() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M25.3 34.7L15.6 25l9.7-9.7l1.4 1.4l-8.3 8.3l8.3 8.3z"/><path fill="currentColor" d="M17 24h17v2H17z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Refresh() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M25 38c-7.2 0-13-5.8-13-13c0-3.2 1.2-6.2 3.3-8.6l1.5 1.3C15 19.7 14 22.3 14 25c0 6.1 4.9 11 11 11c1.6 0 3.1-.3 4.6-1l.8 1.8c-1.7.8-3.5 1.2-5.4 1.2zm9.7-4.3l-1.5-1.3c1.8-2 2.8-4.6 2.8-7.3c0-6.1-4.9-11-11-11c-1.6 0-3.1.3-4.6 1l-.8-1.8c1.7-.8 3.5-1.2 5.4-1.2c7.2 0 13 5.8 13 13c0 3.1-1.2 6.2-3.3 8.6z"/><path fill="currentColor" d="M18 24h-2v-6h-6v-2h8zm22 10h-8v-8h2v6h6z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ScVimeo() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M38 19.6c-.1 2.7-2 6.4-5.6 11.1c-3.8 4.9-7 7.4-9.6 7.4c-1.6 0-3-1.5-4.1-4.5c-.7-2.7-1.5-5.5-2.2-8.2c-.8-3-1.7-4.5-2.7-4.5c-.2 0-.9.4-2.2 1.3l-1.3-1.7c1.4-1.2 2.7-2.4 4-3.6c1.8-1.6 3.2-2.4 4.1-2.5c2.2-.2 3.5 1.3 4 4.4c.5 3.4.9 5.5 1.1 6.4c.6 2.8 1.3 4.2 2.1 4.2c.6 0 1.5-.9 2.6-2.8c1.2-1.8 1.8-3.2 1.9-4.2c.2-1.6-.5-2.4-1.9-2.4c-.7 0-1.3.2-2 .5c1.4-4.5 4-6.6 7.8-6.5c2.8.1 4.2 1.9 4 5.6z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ArrowUp() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M33.3 26.7L25 18.4l-8.3 8.3l-1.4-1.4l9.7-9.7l9.7 9.7z"/><path fill="currentColor" d="M24 17h2v17h-2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ScGooglePlus() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" fill-rule="evenodd" d="M18 23v4.8h7.9c-.3 2.1-2.4 6-7.9 6c-4.8 0-8.7-4-8.7-8.8s3.9-8.8 8.7-8.8c2.7 0 4.5 1.2 5.6 2.2l3.8-3.7C24.9 12.4 21.8 11 18 11c-7.7 0-14 6.3-14 14s6.3 14 14 14c8.1 0 13.4-5.7 13.4-13.7c0-.9-.1-1.6-.2-2.3H18zm30 0h-4v-4h-4v4h-4v4h4v4h4v-4h4z" clip-rule="evenodd"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ScYoutube() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M39.7 18.6s-.3-2.1-1.2-3c-1.1-1.2-2.4-1.2-3-1.3C31.3 14 25 14 25 14s-6.3 0-10.5.3c-.6.1-1.9.1-3 1.3c-.9.9-1.2 3-1.2 3S10 21 10 23.4v2.2c0 2.4.3 4.9.3 4.9s.3 2.1 1.2 3c1.1 1.2 2.6 1.2 3.3 1.3c2.4.1 10.2.2 10.2.2s6.3 0 10.5-.3c.6-.1 1.9-.1 3-1.3c.9-.9 1.2-3 1.2-3s.3-2.4.3-4.8v-2.2c0-2.4-.3-4.8-.3-4.8zm-17.8 9.8V20l8.1 4.2l-8.1 4.2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Trash() *handlebars.ElementSVG {
	return handlebars.SVG(`<path fill="currentColor" d="M20 18h2v16h-2zm4 0h2v16h-2zm4 0h2v16h-2zm-16-6h26v2H12zm18 0h-2v-1c0-.6-.4-1-1-1h-4c-.6 0-1 .4-1 1v1h-2v-1c0-1.7 1.3-3 3-3h4c1.7 0 3 1.3 3 3v1z"/><path fill="currentColor" d="M31 40H19c-1.6 0-3-1.3-3.2-2.9l-1.8-24l2-.2l1.8 24c0 .6.6 1.1 1.2 1.1h12c.6 0 1.1-.5 1.2-1.1l1.8-24l2 .2l-1.8 24C34 38.7 32.6 40 31 40z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
