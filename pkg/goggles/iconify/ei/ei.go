...
func Archive() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M42 20h-2v-5c0-.6-.4-1-1-1H11c-.6 0-1 .4-1 1v5H8v-5c0-1.7 1.3-3 3-3h28c1.7 0 3 1.3 3 3v5zm-5 20H13c-1.7 0-3-1.3-3-3V20h2v17c0 .6.4 1 1 1h24c.6 0 1-.4 1-1V20h2v17c0 1.7-1.3 3-3 3z"/><path fill="currentColor" d="M29 26h-8c-.6 0-1-.4-1-1s.4-1 1-1h8c.6 0 1 .4 1 1s-.4 1-1 1zM8 18h34v2H8z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ArrowDown() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="m25 34.4l-9.7-9.7l1.4-1.4l8.3 8.3l8.3-8.3l1.4 1.4z"/><path fill="currentColor" d="M24 16h2v17h-2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ArrowLeft() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M25.3 34.7L15.6 25l9.7-9.7l1.4 1.4l-8.3 8.3l8.3 8.3z"/><path fill="currentColor" d="M17 24h17v2H17z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ArrowRight() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="m24.7 34.7l-1.4-1.4l8.3-8.3l-8.3-8.3l1.4-1.4l9.7 9.7z"/><path fill="currentColor" d="M16 24h17v2H16z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ArrowUp() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M33.3 26.7L25 18.4l-8.3 8.3l-1.4-1.4l9.7-9.7l9.7 9.7z"/><path fill="currentColor" d="M24 17h2v17h-2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Bell() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M42 36c-6.5 0-7.4-6.3-8.2-11.9C32.9 17.9 32.1 12 25 12s-7.9 5.9-8.8 12.1C15.4 29.7 14.5 36 8 36v-2c4.6 0 5.3-3.9 6.2-10.1c.9-6.2 2-13.9 10.8-13.9s9.9 7.7 10.8 13.9C36.7 30.1 37.4 34 42 34v2z"/><path fill="currentColor" d="M25 40c-2.8 0-5-2.2-5-5h2c0 1.7 1.3 3 3 3s3-1.3 3-3h2c0 2.8-2.2 5-5 5z"/><path fill="currentColor" d="M8 34h34v2H8zm19-24c0 1.1-.9 1.5-2 1.5s-2-.4-2-1.5s.9-2 2-2s2 .9 2 2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Calendar() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M37 38H13c-1.7 0-3-1.3-3-3V13c0-1.7 1.1-3 2.5-3H14v2h-1.5c-.2 0-.5.4-.5 1v22c0 .6.4 1 1 1h24c.6 0 1-.4 1-1V13c0-.6-.3-1-.5-1H36v-2h1.5c1.4 0 2.5 1.3 2.5 3v22c0 1.7-1.3 3-3 3z"/><path fill="currentColor" d="M17 14c-.6 0-1-.4-1-1V9c0-.6.4-1 1-1s1 .4 1 1v4c0 .6-.4 1-1 1zm16 0c-.6 0-1-.4-1-1V9c0-.6.4-1 1-1s1 .4 1 1v4c0 .6-.4 1-1 1zm-13-4h10v2H20zm-8 6h26v2H12zm22 4h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm16 4h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm20 4h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm16 4h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2zm-4 0h2v2h-2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Camera() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M39 38H11c-1.7 0-3-1.3-3-3V17c0-1.7 1.3-3 3-3h6c.2 0 .5-.2.6-.3l1.1-2.2c.4-.8 1.4-1.4 2.3-1.4h8c.9 0 1.9.6 2.3 1.4l1.1 2.2c.1.2.4.3.6.3h6c1.7 0 3 1.3 3 3v18c0 1.7-1.3 3-3 3zM11 16c-.6 0-1 .4-1 1v18c0 .6.4 1 1 1h28c.6 0 1-.4 1-1V17c0-.6-.4-1-1-1h-6c-.9 0-1.9-.6-2.3-1.4l-1.1-2.2c-.1-.2-.4-.4-.6-.4h-8c-.2 0-.5.2-.6.3l-1.1 2.2c-.4.9-1.4 1.5-2.3 1.5h-6z"/><path fill="currentColor" d="M25 34c-5 0-9-4-9-9s4-9 9-9s9 4 9 9s-4 9-9 9zm0-16c-3.9 0-7 3.1-7 7s3.1 7 7 7s7-3.1 7-7s-3.1-7-7-7z"/><circle cx="35" cy="18" r="1" fill="currentColor"/><path fill="currentColor" d="M12 12h4v1h-4zm13 9v-1c-2.8 0-5 2.2-5 5h1c0-2.2 1.8-4 4-4z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Cart() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M35 34H13c-.3 0-.6-.2-.8-.4s-.2-.6-.1-.9l1.9-4.8L12.1 10H6V8h7c.5 0 .9.4 1 .9l2 19c0 .2 0 .3-.1.5L14.5 32H36l-1 2z"/><path fill="currentColor" d="m15.2 29l-.4-2L38 22.2V14H14v-2h25c.6 0 1 .4 1 1v10c0 .5-.3.9-.8 1l-24 5zM36 40c-2.2 0-4-1.8-4-4s1.8-4 4-4s4 1.8 4 4s-1.8 4-4 4zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2s2-.9 2-2s-.9-2-2-2zm-24 6c-2.2 0-4-1.8-4-4s1.8-4 4-4s4 1.8 4 4s-1.8 4-4 4zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2s2-.9 2-2s-.9-2-2-2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Chart() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M18 36h-2V26h-4v10h-2V24h8zm10 0h-2V20h-4v16h-2V18h8zm10 0h-2V14h-4v22h-2V12h8zM8 36h32v2H8z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Check() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="m23 32.4l-8.7-8.7l1.4-1.4l7.3 7.3l11.3-11.3l1.4 1.4z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ChevronDown() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m25 32.4l-9.7-9.7l1.4-1.4l8.3 8.3l8.3-8.3l1.4 1.4z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ChevronLeft() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M27.3 34.7L17.6 25l9.7-9.7l1.4 1.4l-8.3 8.3l8.3 8.3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ChevronRight() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m22.7 34.7l-1.4-1.4l8.3-8.3l-8.3-8.3l1.4-1.4l9.7 9.7z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ChevronUp() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M33.3 28.7L25 20.4l-8.3 8.3l-1.4-1.4l9.7-9.7l9.7 9.7z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Clock() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M30.3 33.7L24 27.4V16h2v10.6l5.7 5.7z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Close() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m37.304 11.282l1.414 1.414l-26.022 26.02l-1.414-1.413z"/><path fill="currentColor" d="m12.696 11.282l26.022 26.02l-1.414 1.415l-26.022-26.02z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func CloseO() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="m32.283 16.302l1.414 1.415l-15.98 15.98l-1.414-1.414z"/><path fill="currentColor" d="m17.717 16.302l15.98 15.98l-1.414 1.415l-15.98-15.98z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Comment() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M15 42h-2l1.2-1.6c.8-1.1 1.3-2.5 1.6-4.2C10.8 33.9 8 29.6 8 24c0-8.6 6.5-14 17-14s17 5.4 17 14c0 8.8-6.4 14-17 14h-.7c-1.6 1.9-4.4 4-9.3 4zm10-30c-9.4 0-15 4.5-15 12c0 6.4 3.9 9.4 7.2 10.7l.7.3l-.1.8c-.2 1.6-.5 3-1.1 4.2c3.3-.4 5.2-2.1 6.3-3.5l.3-.4H25c13.5 0 15-8.4 15-12C40 16.5 34.4 12 25 12z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func CreditCard() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M39 38H11c-1.7 0-3-1.3-3-3V15c0-1.7 1.3-3 3-3h28c1.7 0 3 1.3 3 3v20c0 1.7-1.3 3-3 3zM11 14c-.6 0-1 .4-1 1v20c0 .6.4 1 1 1h28c.6 0 1-.4 1-1V15c0-.6-.4-1-1-1H11z"/><path fill="currentColor" d="M9 16h32v6H9zm3 10h1v2h-1zm2 0h1v2h-1zm2 0h1v2h-1zm3 0h1v2h-1zm2 0h1v2h-1zm2 0h1v2h-1zm3 0h1v2h-1zm2 0h1v2h-1zm2 0h1v2h-1zm3 0h1v2h-1zm2 0h1v2h-1zm2 0h1v2h-1z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Envelope() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m31.796 24.244l9.97 9.97l-1.415 1.414l-9.97-9.97zm-13.518.043l1.414 1.414l-9.9 9.9l-1.414-1.41z" opacity=".9"/><path fill="currentColor" d="M25 29.9c-1.5 0-3.1-.6-4.2-1.8L8.3 15.7l1.4-1.4l12.5 12.5c1.6 1.6 4.1 1.6 5.7 0l12.5-12.5l1.4 1.4l-12.6 12.5c-1.1 1.1-2.7 1.7-4.2 1.7z"/><path fill="currentColor" d="M39 38H11c-1.7 0-3-1.3-3-3V15c0-1.7 1.3-3 3-3h28c1.7 0 3 1.3 3 3v20c0 1.7-1.3 3-3 3zM11 14c-.6 0-1 .4-1 1v20c0 .6.4 1 1 1h28c.6 0 1-.4 1-1V15c0-.6-.4-1-1-1H11z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Exclamation() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M24 32h2v2h-2zm1.6-2h-1.2l-.4-8v-6h2v6z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func ExternalLink() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m38.288 10.297l1.414 1.415l-14.99 14.99l-1.414-1.414z"/><path fill="currentColor" d="M40 20h-2v-8h-8v-2h10zm-5 18H15c-1.7 0-3-1.3-3-3V15c0-1.7 1.3-3 3-3h11v2H15c-.6 0-1 .4-1 1v20c0 .6.4 1 1 1h20c.6 0 1-.4 1-1V24h2v11c0 1.7-1.3 3-3 3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Eye() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 36C13.5 36 8.3 25.9 8.1 25.4c-.1-.3-.1-.6 0-.9C8.3 24.1 13.5 14 25 14s16.7 10.1 16.9 10.6c.1.3.1.6 0 .9c-.2.4-5.4 10.5-16.9 10.5zM10.1 25c1.1 1.9 5.9 9 14.9 9s13.7-7.1 14.9-9c-1.1-1.9-5.9-9-14.9-9s-13.7 7.1-14.9 9z"/><path fill="currentColor" d="M25 34c-5 0-9-4-9-9s4-9 9-9s9 4 9 9s-4 9-9 9zm0-16c-3.9 0-7 3.1-7 7s3.1 7 7 7s7-3.1 7-7s-3.1-7-7-7z"/><path fill="currentColor" d="M25 30c-2.8 0-5-2.2-5-5c0-.6.4-1 1-1s1 .4 1 1c0 1.7 1.3 3 3 3s3-1.3 3-3s-1.3-3-3-3c-.6 0-1-.4-1-1s.4-1 1-1c2.8 0 5 2.2 5 5s-2.2 5-5 5z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Gear() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 34c-5 0-9-4-9-9s4-9 9-9s9 4 9 9s-4 9-9 9zm0-16c-3.9 0-7 3.1-7 7s3.1 7 7 7s7-3.1 7-7s-3.1-7-7-7z"/><path fill="currentColor" d="M27.7 44h-5.4l-1.5-4.6c-1-.3-2-.7-2.9-1.2l-4.4 2.2l-3.8-3.8l2.2-4.4c-.5-.9-.9-1.9-1.2-2.9L6 27.7v-5.4l4.6-1.5c.3-1 .7-2 1.2-2.9l-2.2-4.4l3.8-3.8l4.4 2.2c.9-.5 1.9-.9 2.9-1.2L22.3 6h5.4l1.5 4.6c1 .3 2 .7 2.9 1.2l4.4-2.2l3.8 3.8l-2.2 4.4c.5.9.9 1.9 1.2 2.9l4.6 1.5v5.4l-4.6 1.5c-.3 1-.7 2-1.2 2.9l2.2 4.4l-3.8 3.8l-4.4-2.2c-.9.5-1.9.9-2.9 1.2L27.7 44zm-4-2h2.6l1.4-4.3l.5-.1c1.2-.3 2.3-.8 3.4-1.4l.5-.3l4 2l1.8-1.8l-2-4l.3-.5c.6-1 1.1-2.2 1.4-3.4l.1-.5l4.3-1.4v-2.6l-4.3-1.4l-.1-.5c-.3-1.2-.8-2.3-1.4-3.4l-.3-.5l2-4l-1.8-1.8l-4 2l-.5-.3c-1.1-.6-2.2-1.1-3.4-1.4l-.5-.1L26.3 8h-2.6l-1.4 4.3l-.5.1c-1.2.3-2.3.8-3.4 1.4l-.5.3l-4-2l-1.8 1.8l2 4l-.3.5c-.6 1-1.1 2.2-1.4 3.4l-.1.5L8 23.7v2.6l4.3 1.4l.1.5c.3 1.2.8 2.3 1.4 3.4l.3.5l-2 4l1.8 1.8l4-2l.5.3c1.1.6 2.2 1.1 3.4 1.4l.5.1l1.4 4.3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Heart() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m25 39.7l-.6-.5C11.5 28.7 8 25 8 19c0-5 4-9 9-9c4.1 0 6.4 2.3 8 4.1c1.6-1.8 3.9-4.1 8-4.1c5 0 9 4 9 9c0 6-3.5 9.7-16.4 20.2l-.6.5zM17 12c-3.9 0-7 3.1-7 7c0 5.1 3.2 8.5 15 18.1c11.8-9.6 15-13 15-18.1c0-3.9-3.1-7-7-7c-3.5 0-5.4 2.1-6.9 3.8L25 17.1l-1.1-1.3C22.4 14.1 20.5 12 17 12z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
...
func Like() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M40 23.2c0-2.1-1.7-3.2-4-3.2h-6.7c.5-1.8.7-3.5.7-5c0-5.8-1.6-7-3-7c-.9 0-1.6.1-2.5.6c-.3.2-.4.4-.5.7l-1 5.4c-1.1 2.8-3.8 5.3-6 7V36c.8 0 1.6.4 2.6.9c1.1.5 2.2 1.1 3.4 1.1h9.5c2 0 3.5-1.6 3.5-3c0-.3 0-.5-.1-.7c1.2-.5 2.1-1.5 2.1-2.8c0-.6-.1-1.1-.3-1.6c.8-.5 1.5-1.4 1.5-2.4c0-.6-.3-1.2-.6-1.7c.8-.6 1.4-1.6 1.4-2.6zm-2.1 0c0 1.3-1.3 1.4-1.5 2c-.2.7.8.9.8 2.1c0 1.2-1.5 1.2-1.7 1.9c-.2.8.5 1 .5 2.2v.2c-.2 1-1.7 1.1-2 1.5c-.3.5 0 .7 0 1.8c0 .6-.7 1-1.5 1H23c-.8 0-1.6-.4-2.6-.9c-.8-.4-1.6-.8-2.4-1V23.5c2.5-1.9 5.7-4.7 6.9-8.2v-.2l.9-5c.4-.1.7-.1 1.2-.1c.2 0 1 1.2 1 5c0 1.5-.3 3.1-.8 5H27c-.6 0-1 .4-1 1s.4 1 1 1h9c1 0 1.9.5 1.9 1.2z"/><path fill="currentColor" d="M16 38h-6c-1.1 0-2-.9-2-2V22c0-1.1.9-2 2-2h6c1.1 0 2 .9 2 2v14c0 1.1-.9 2-2 2zm-6-16v14h6V22h-6z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Link() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M24 30.2c0 .2.1.5.1.8c0 1.4-.5 2.6-1.5 3.6l-2 2c-1 1-2.2 1.5-3.6 1.5c-2.8 0-5.1-2.3-5.1-5.1c0-1.4.5-2.6 1.5-3.6l2-2c1-1 2.2-1.5 3.6-1.5c.3 0 .5 0 .8.1l1.5-1.5c-.7-.3-1.5-.4-2.3-.4c-1.9 0-3.6.7-4.9 2l-2 2c-1.3 1.3-2 3-2 4.9c0 3.8 3.1 6.9 6.9 6.9c1.9 0 3.6-.7 4.9-2l2-2c1.3-1.3 2-3 2-4.9c0-.8-.1-1.6-.4-2.3L24 30.2zm9-20.1c-1.9 0-3.6.7-4.9 2l-2 2c-1.3 1.3-2 3-2 4.9c0 .8.1 1.6.4 2.3l1.5-1.5c0-.2-.1-.5-.1-.8c0-1.4.5-2.6 1.5-3.6l2-2c1-1 2.2-1.5 3.6-1.5c2.8 0 5.1 2.3 5.1 5.1c0 1.4-.5 2.6-1.5 3.6l-2 2c-1 1-2.2 1.5-3.6 1.5c-.3 0-.5 0-.8-.1l-1.5 1.5c.7.3 1.5.4 2.3.4c1.9 0 3.6-.7 4.9-2l2-2c1.3-1.3 2-3 2-4.9c0-3.8-3.1-6.9-6.9-6.9z"/><path fill="currentColor" d="M20 31c-.3 0-.5-.1-.7-.3c-.4-.4-.4-1 0-1.4l10-10c.4-.4 1-.4 1.4 0s.4 1 0 1.4l-10 10c-.2.2-.4.3-.7.3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Location() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m25 42.5l-.8-.9C23.7 41.1 12 27.3 12 19c0-7.2 5.8-13 13-13s13 5.8 13 13c0 8.3-11.7 22.1-12.2 22.7l-.8.8zM25 8c-6.1 0-11 4.9-11 11c0 6.4 8.4 17.2 11 20.4c2.6-3.2 11-14 11-20.4c0-6.1-4.9-11-11-11z"/><path fill="currentColor" d="M25 24c-2.8 0-5-2.2-5-5s2.2-5 5-5s5 2.2 5 5s-2.2 5-5 5zm0-8c-1.7 0-3 1.3-3 3s1.3 3 3 3s3-1.3 3-3s-1.3-3-3-3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Lock() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M34 23h-2v-4c0-3.9-3.1-7-7-7s-7 3.1-7 7v4h-2v-4c0-5 4-9 9-9s9 4 9 9v4z"/><path fill="currentColor" d="M33 40H17c-1.7 0-3-1.3-3-3V25c0-1.7 1.3-3 3-3h16c1.7 0 3 1.3 3 3v12c0 1.7-1.3 3-3 3zM17 24c-.6 0-1 .4-1 1v12c0 .6.4 1 1 1h16c.6 0 1-.4 1-1V25c0-.6-.4-1-1-1H17z"/><circle cx="25" cy="28" r="2" fill="currentColor"/><path fill="currentColor" d="M25.5 28h-1l-1 6h3z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Minus() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M16 24h18v2H16z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Navicon() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M10 12h30v4H10zm0 10h30v4H10zm0 10h30v4H10z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Paperclip() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M13.8 39.6c-1.5 0-3.1-.6-4.2-1.8c-2.3-2.3-2.3-6.1 0-8.5l17-17c3.1-3.1 8.2-3.1 11.3 0c3.1 3.1 3.1 8.2 0 11.3L25.1 36.4L23.7 35l12.7-12.7c2.3-2.3 2.3-6.1 0-8.5c-2.3-2.3-6.1-2.3-8.5 0l-17 17c-.8.8-1.2 1.8-1.2 2.8c0 1.1.4 2.1 1.2 2.8c1.6 1.6 4.1 1.6 5.7 0l12.7-12.7c.8-.8.8-2 0-2.8c-.8-.8-2-.8-2.8 0L18 29.3l-1.4-1.4l8.5-8.5c1.6-1.6 4.1-1.6 5.7 0c1.6 1.6 1.6 4.1 0 5.7L18 37.8c-1.1 1.2-2.7 1.8-4.2 1.8z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Pencil() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="m9.6 40.4l2.5-9.9L27 15.6l7.4 7.4l-14.9 14.9l-9.9 2.5zm4.3-8.9l-1.5 6.1l6.1-1.5L31.6 23L27 18.4L13.9 31.5z"/><path fill="currentColor" d="M17.8 37.3c-.6-2.5-2.6-4.5-5.1-5.1l.5-1.9c3.2.8 5.7 3.3 6.5 6.5l-1.9.5z"/><path fill="currentColor" d="m29.298 19.287l1.414 1.414l-13.01 13.02l-1.414-1.41zM11 39l2.9-.7c-.3-1.1-1.1-1.9-2.2-2.2L11 39zm24-16.6L27.6 15l3-3l.5.1c3.6.5 6.4 3.3 6.9 6.9l.1.5l-3.1 2.9zM30.4 15l4.6 4.6l.9-.9c-.5-2.3-2.3-4.1-4.6-4.6l-.9.9z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Play() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M20 33.7V16.3L35 25l-15 8.7zm2-14v10.5l9-5.3l-9-5.2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Plus() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M25 42c-9.4 0-17-7.6-17-17S15.6 8 25 8s17 7.6 17 17s-7.6 17-17 17zm0-32c-8.3 0-15 6.7-15 15s6.7 15 15 15s15-6.7 15-15s-6.7-15-15-15z"/><path fill="currentColor" d="M16 24h18v2H16z"/><path fill="currentColor" d="M24 16h2v18h-2z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
func Pointer() *goggles.ElementSVG {
	return goggles.SVG(`<path fill="currentColor" d="M33 38H21c-.6 0-1-.4-1-1c0-1.5-.7-2.4-1.8-3.8c-.6-.7-1.3-1.6-2-2.7c-1.9-3-3.6-6.6-4-7.9c-.4-1.3-.1-2.2.3-2.7c.4-.6 1.2-.9 2.1-.9c1.2 0 2.4 1 3.5 2.3V11c0-1.7 1.3-3 3-3s3 1.3 3 3v4.2c.3-.1.6-.2 1-.2c1.1 0 2 .6 2.5 1.4c.4-.3.9-.4 1.4-.4c1.4 0 2.5.9 2.9 2.2c.3-.1.7-.2 1.1-.2c1.7 0 3 1.3 3 3v3c0 2.6-.5 4.7-1 6.7s-1 3.9-1 6.3c0 .6-.4 1-1 1zm-11.1-2H32c.1-2.2.6-4 1-5.8c.5-2 1-3.9 1-6.2v-3c0-.6-.4-1-1-1s-1 .4-1 1v1c0 .6-.4 1-1 1s-1-.4-1-1v-3c0-.6-.4-1-1-1s-1 .4-1 1v2c0 .6-.4 1-1 1s-1-.4-1-1v-3c0-.6-.4-1-1-1s-1 .4-1 1v2c0 .6-.4 1-1 1s-1-.4-1-1v-9c0-.6-.4-1-1-1s-1 .4-1 1v15c0 .6-.4 1-1 1s-1-.4-1-1v-.8c-.9-2.3-2.8-4.2-3.5-4.2c-.2 0-.4 0-.5.1c-.1.1-.1.4 0 .9c.3 1.1 1.8 4.3 3.8 7.5c.6 1 1.2 1.7 1.8 2.5c1.1 1.2 2.1 2.3 2.3 4z"/>`).
		Custom("viewBox", "0,0,50,50").
		Custom("width", "1em").
		Custom("height", "1em")
}
