...
func CANVAS(children ...any) *ElementCanvas {
	return &ElementCanvas{
		baseElement: newBaseElement("canvas", children...),
	}
}
...
func (e *ElementCanvas) Custom(k, v string, dontEscape ...bool) *ElementCanvas {
	e.baseElement.custom(k, v, dontEscape...)
	return e
}

func (e *ElementCanvas) BindCustom(k string, v string, dontEscape ...bool) *ElementCanvas {
	e.baseElement.bindCustom(k, v, dontEscape...)
	return e
}

func (e *ElementCanvas) appendAttribute(k string, v string, dontEscape ...bool) *ElementCanvas {
...
//   - characters
//   - characters
func (element *ElementCanvas) Autocapitalize(v string, dontEscape ...bool) *ElementCanvas {
...
//   - send
//   - send
func (element *ElementCanvas) Enterkeyhint(v string, dontEscape ...bool) *ElementCanvas {
...
// Valid values are constrained to the following:
//   - boolean_attribute
func (element *ElementCanvas) Inert(v string, dontEscape ...bool) *ElementCanvas {
...
// Valid values are constrained to the following:
func (element *ElementCanvas) Lang(v string, dontEscape ...bool) *ElementCanvas {
...
//   - manual
//   - manual
func (element *ElementCanvas) Popover(v string, dontEscape ...bool) *ElementCanvas {
...
//   - search
//   - search
func (element *ElementCanvas) Inputmode(v string, dontEscape ...bool) *ElementCanvas {
